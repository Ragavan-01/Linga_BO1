...
public class Enterprise_Advertisements {
	...
	public void flushTest() throws Exception
	{
		...
		@Test(priority=28)
		public void Advertisement_page() throws Exception
		{
		...
		@Test(priority=29)
		public void Advertisement_Refreshpage() throws InterruptedException
		{
		...
		@Test(priority=30)
		public void Advertisement_Setting_Method_pagination() throws InterruptedException
		{
		...
		@Test(priority=31)
		public void Advertisement_Newcreationpage() throws InterruptedException
		{
			//Scroll the web page
		    for(int i=1; i <= 15; i++)
		    {
		...
		@Test(priority=32)
		public void Advertisement_New_Always() throws Exception
		{
		...
		@Test(priority=33)
		public void Advertisement_Close() throws Exception
		{
			Thread.sleep(3000);
			//Click Advertisement creation button
			driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div/div[1]/div/div/div/button")).click();
		...
		@Test(priority=34)
		public void Advertisement_Edit_Daysofweek() throws Exception
		{
			//Clear the search field
		...
		@Test(priority=35)
		public void Advertisement_delete() throws Exception
		{
		...
		@Test(priority=36)
		public void Advertisement_deActive() throws Exception
		{
		...
		@Test(priority=37)
		public void Advertisement_AS_DaysOfMonth() throws Exception
		{
				//Clear the search field
				driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div/div[2]/div/div/div/div[2]/div[1]/div[2]/label/input")).clear();
				//Enter the required keyword
		...
		@Test(priority=38)
		public void Advertisement_AS_DateRange() throws Exception
		{
				//Clear the search field
				driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div/div[2]/div/div/div/div[2]/div[1]/div[2]/label/input")).clear();
				//Enter the required keyword
		...
		@Test(priority=39)
		public void Advertisement_AS_Specific_date() throws Exception
		{
				//Clear the search field
				driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div/div[2]/div/div/div/div[2]/div[1]/div[2]/label/input")).clear();
				//Enter the required keyword
		...
		@Test(priority=40)
		public void Advertisement_AS_Startdatetime_enddatetime() throws Exception
		{
				//Clear the search field
				driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div/div[2]/div/div/div/div[2]/div[1]/div[2]/label/input")).clear();
				//Enter the required keyword
