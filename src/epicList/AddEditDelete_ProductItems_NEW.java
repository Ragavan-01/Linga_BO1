...
public class AddEditDelete_ProductItems_NEW {
	...
	@Test(priority=2)
	public void Product_And_Item_method_openProductsItems() throws Exception
	{
		Thread.sleep(15000);
...
*/		
	...
	@Test(priority=3)
	public void Product_And_Item_method_refreshMenuItemPage() throws InterruptedException
	{
	...
	@Test(priority=3)
	public void Product_And_Item_method_pagination() throws InterruptedException
	{
...
/*	@Test(priority=4)
	public void Product_And_Item_method_addMenuItem() throws Exception
	{
		for (int i = 0; i < 10; i++) {
			driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
			driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
...
/*		//Click the Optional modifier option
	...
	@Test(priority=5)
	public void Product_And_Item_method_editMenuItem() throws Exception
	{
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		Thread.sleep(3000);
	...
	@Test(priority=6)
	public void Product_And_Item_method_deleteMenuItem() throws Exception
	{
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		Thread.sleep(5000);
	...
	@Test(priority=7)
	public void Product_And_Item_method_addMenuItemByCopyMenuItem() throws Exception
	{
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		Thread.sleep(8000);
	...
	@Test(priority=8)
	public void Product_And_Item_method_cancelMenuItemByCopyMenuItem_Basic() throws Exception
	{
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		Thread.sleep(5000);
	...
	@Test(priority=9)
	public void Product_And_Item_method_cancelMenuItemByCopyMenuItem_Included_Modifiers() throws Exception
	{
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		Thread.sleep(5000);
	...
	@Test(priority=10)
	public void Product_And_Item_method_cancelMenuItemByCopyMenuItem_Optional_Modifier_Groups() throws Exception
	{
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		Thread.sleep(5000);
	...
	@Test(priority=11)
	public void Product_And_Item_method_cancelMenuItemByCopyMenuItem_Mandatory_Modifier() throws Exception
	{
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		Thread.sleep(5000);
	...
	@Test(priority=12)
	public void Product_And_Item_method_saveMenuItemByCopyMenuItem() throws Exception
	{
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		Thread.sleep(5000);
	...
	@Test(priority=13)
	public void Product_And_Item_method_saveAndContinueMenuItemByCopyMenuItem() throws Exception
	{
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		Thread.sleep(5000);
