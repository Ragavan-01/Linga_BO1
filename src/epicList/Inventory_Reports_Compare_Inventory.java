...
public class Inventory_Reports_Compare_Inventory {
	...
	@Test(priority=45) 
	public void Inventory_Reports_Compare_Inventory_Openpage() throws Exception
	{
	...
	@Test(priority=46) 
	public void Inventory_Reports_Compare_Inventory_ALL() throws Exception
	{
				Thread.sleep(3000);
			//Select type as ALL 
	...
	@Test(priority=47) 
	public void Inventory_Reports_Compare_Inventory_Item() throws Exception
	{
				Thread.sleep(3000);
				//Select type as ALL 
	...
	@Test(priority=48) 
	public void Inventory_Reports_Compare_SubRecipe() throws Exception
	{
				Thread.sleep(3000);
				//Select type as ALL 
