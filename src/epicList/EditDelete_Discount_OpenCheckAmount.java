...
public class EditDelete_Discount_OpenCheckAmount {
	...
	@Test(priority=91)
	public void Open_Check_Discount_method_editDiscount_OpenCheck() throws Exception
	{
	...
	@Test(priority=92)
	public void Open_Check_Discount_method_deleteOrActiveDiscount_OpenCheck() throws Exception
	{
		Thread.sleep(10000);
	...
	@Test(priority=93)
	public void Open_Check_Discount_method_cancelButton() throws Exception
	{
