...
public class Verify_SubCategorySale_Report {
	...
	else
	{
		...
		driver.close();
			...
			public void Sub_Category_Sale_method__OpenPageReport() throws Exception
			{
			...
			public void Sub_Category_Sale_method_For_Specific_Date() throws Exception
			{
				Thread.sleep(2000);
		...
		/*		        //Print number of Rows
			...
			public void Sub_Category_Sale_method_For_Specific_Date_With_Quantity_Sort() throws Exception
			{
				Thread.sleep(2000);
				WebElement html = driver.findElement(By.tagName("html"));
				html.sendKeys(Keys.chord(Keys.CONTROL, Keys.SUBTRACT));
		...
		/*		        //Print number of Rows
			...
			public void Sub_Category_Sale_method_For_Specific_Date_WithOut_Quantity_Sort_With_Dynamic_Report() throws Exception
			{
				Thread.sleep(2000);
				WebElement html = driver.findElement(By.tagName("html"));
				html.sendKeys(Keys.chord(Keys.CONTROL, Keys.SUBTRACT));
			...
			public void Sub_Category_Sale_method_For_Specific_Date_With_Quantity_And_With_Dynamic_Report() throws Exception
			{
				Thread.sleep(2000);
				WebElement html = driver.findElement(By.tagName("html"));
