...
public class Verify_DailySale_Report {
	...
	public void Daily_Sale_method_openpage_Report() throws Exception
			{
	...
	public void Daily_Sale_method_Report_For_Specific_Date() throws Exception
	{
				Thread.sleep(2000);
	...
	public void Daily_Sale_method_Report_For_Specific_Date_With_Dynamic_Report() throws Exception
	{
			Thread.sleep(2000);
			WebElement html = driver.findElement(By.tagName("html"));
			html.sendKeys(Keys.chord(Keys.CONTROL, Keys.SUBTRACT));
