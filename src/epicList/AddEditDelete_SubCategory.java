...
public class AddEditDelete_SubCategory {
	...
	public void flushTest() throws Exception
	{
		...
		@Test(priority=101)
		public void Subcategory_method_openSubCategory_Page() throws Exception
		{
		...
		@Test(priority=102)
		public void Subcategory_method_refreshCategory_Page() throws InterruptedException
		{
			Thread.sleep(5000);
			//Click the refresh button
		...
		@Test(priority=104)
		public void Subcategory_method_add_SubCategory() throws Exception
		{
			for (int i = 0; i < 10; i++) {
		...
		@Test(priority=105)
		public void Subcategory_method_edit_SubCategory_DaysOfWeek() throws Exception
		{
		...
		@Test(priority=106)
		public void Subcategory_method_edit_Sub_Category_DaysOfMonth() throws Exception
		{
		...
		@Test(priority=107)
		public void Subcategory_method_edit_Sub_Category_DateRange() throws Exception
		{
		...
		@Test(priority=108)
		public void Subcategory_method_edit_Sub_Category_SpecificDate() throws Exception
		{
		...
		@Test(priority=109)
		public void Subcategory_method_edit_Sub_Category_StartDateAndEndDate() throws Exception
		{
		...
		@Test(priority=110)
		public void Subcategory_method_delete_Sub_Category() throws Exception
		{
			Thread.sleep(5000);
			//Clear the Search field
			driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
		...
		@Test(priority=111)
		public void Subcategory_method_cancelSubCategory() throws Exception
		{
			Thread.sleep(3000);
			//Clear the Search field
			driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
		...
		@Test(priority=112)
		public void Subcategory_method_inactiveAndActive_Button() throws Exception
		{
			Thread.sleep(3000);
