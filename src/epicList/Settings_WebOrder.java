...
public class Settings_WebOrder {
	...
	ExtentTest test = rep.startTest("Settings_WebOrder");
	...
	@Test(priority=23)
	public void Web_Order_Settings_Method_pageopen() throws Exception
		{
	...
	@Test(priority=24)
	public void WebOrder_Settings_Method_update() throws Exception
		{		
				Thread.sleep(5000);
