...
public class AddEditDelete_VoidReasons {
	...
	@Test(priority=101)
	public void Reasons_Void_Reasons_method_openVoidReasons() throws Exception
	{
	...
	@Test(priority=102)
	public void Reasons_Void_Reasons_method_refreshVoidReasons() throws InterruptedException
	{
		Thread.sleep(5000);
		//Click the refresh button
	...
	@Test(priority=104)
	public void Reasons_Void_Reasons_method_addVoidReasons() throws Exception
	{
		for (int i = 0; i < 10; i++) {
	...
	@Test(priority=105)
	public void Reasons_Void_Reasons_method_editVoidReasons() throws Exception
	{
		Thread.sleep(3000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	@Test(priority=106)
	public void Reasons_Void_Reasons_method_deleteVoidReasons() throws Exception
	{
		Thread.sleep(5000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	@Test(priority=107)
	public void Reasons_Void_Reasons_method_closeButton() throws Exception
	{
		Thread.sleep(5000);
		//Click the Active Button
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[3]/div[1]/div/div/div[2]/div[1]/div[1]/input")).click();
	...
	@Test(priority=108)
	public void Reasons_Void_Reasons_method_verifyActive_InActiveButton() throws Exception
	{
		Thread.sleep(3000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
