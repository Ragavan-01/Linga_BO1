...
public class AddEditDelete_DiscountItemBased {
	...
	@Test(priority=41)
	public void Item_Based_Discount_method_openDiscountsPage() throws Exception
	{
/*		//Click the Products/Items option
	...
	@Test(priority=42)
	public void Item_Based_Discount_method_refreshDiscountsPage() throws InterruptedException
	{
		Thread.sleep(5000);
		//Click the refresh button
	...
	@Test(priority=44)
	public void Item_Based_Discount_method_addDiscount_ItemBased_ApplicableTimePeriodAsDaysOfWeek() throws Exception
	{
		for (int i = 0; i < 10; i++) {
	...
	public void Item_Based_Discount_method_pagination() throws InterruptedException
	{
	...
	@Test(priority=45)
	public void Item_Based_Discount_method_editDiscount_ItemBased() throws Exception
	{
		Thread.sleep(3000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	@Test(priority=46)
	public void Item_Based_Discount_method_deleteDiscount_ItemBased() throws Exception
	{
		Thread.sleep(3000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	@Test(priority=47)
	public void Item_Based_Discount_method_cancelButton() throws Exception
	{
		Thread.sleep(5000);
		//Click on the Add Menu Item option
		driver.findElement(By.id("newDiscount")).click();
	...
	@Test(priority=48)
	public void Item_Based_Discount_method_editDiscount_ItemBased_ApplicableTimePeriodAsAlways_SaveAndPublish() throws Exception
	{
...
//		Thread.sleep(7000);driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	...
	@Test(priority=49)
	public void Item_Based_Discount_method_editDiscount_ItemBased_ApplicableTimePeriodAsDaysOfMonth() throws Exception
	{
		Thread.sleep(5000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
...
/*		//Click the Level Field
	...
	@Test(priority=50)
	public void Item_Based_Discount_method_editDiscount_ItemBased_ApplicableTimePeriodAsDateRange() throws Exception
	{
		Thread.sleep(5000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
...
/*		//Click the Level Field
	...
	@Test(priority=51)
	public void Item_Based_Discount_method_editDiscount_ItemBased_ApplicableTimePeriodAsSpecificDate() throws Exception
	{
		Thread.sleep(5000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
...
/*		//Click the Level Field
	...
	@Test(priority=52)
	public void Item_Based_Discount_method_editDiscount_ItemBased_ApplicableTimePeriodAs_StartDateAndEndDate() throws Exception
	{
		Thread.sleep(5000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
...
/*		//Click the Level Field
	...
	@Test(priority=53)
	public void Item_Based_Discount_method_verifyActive_InActiveButton() throws Exception
	{
		Thread.sleep(10000);
	...
	@Test(priority=54)
	public void Item_Based_Discount_method_addSameName() throws Exception
	{
		Thread.sleep(5000);
		//Click on the Add Menu Item option
		driver.findElement(By.id("newDiscount")).click();
