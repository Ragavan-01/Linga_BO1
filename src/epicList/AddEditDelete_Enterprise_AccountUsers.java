...
public class AddEditDelete_Enterprise_AccountUsers {
	...
	@Test(priority=4)
	public void add_Account_Users() throws Exception
	{
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		Thread.sleep(1000);
		...
		driver.findElement(By.id("userImage")).sendKeys("C:\\Users\\hariprasanth_j\\Desktop\\userProfile.png");
	...
	@Test(priority=10)
	public void delete_Account_Users() throws Exception
	{
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		Thread.sleep(1000);
