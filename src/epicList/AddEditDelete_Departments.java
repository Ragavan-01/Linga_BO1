...
public class AddEditDelete_Departments {
	...
	public void flushTest() throws Exception
	{
		...
		@Test(priority=2)
		public void Department_method_openDepartments() throws Exception
		{
			Thread.sleep(15000);
...
*/			
		...
		@Test(priority=3)
		public void Department_method_refreshDepartments_Page() throws InterruptedException
		{
		...
		@Test(priority=4)
		public void Department_method_add_Department() throws Exception
		{
			for (int i = 0; i < 10; i++) {
				driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
				driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		...
		@Test(priority=5)
		public void Department_method_edit_Department() throws Exception
		{
		...
		@Test(priority=6)
		public void Department_method_delete_Department() throws Exception
		{
			Thread.sleep(5000);
			//Clear the Search field
			driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
		...
		@Test(priority=7)
		public void Department_method_cancelDepartemnt() throws Exception
		{
			Thread.sleep(3000);
			//Clear the Search field
			driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
		...
		@Test(priority=8)
		public void Department_method_inactiveAndActive_Button() throws Exception
		{
			Thread.sleep(3000);
