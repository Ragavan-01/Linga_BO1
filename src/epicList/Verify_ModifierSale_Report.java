...
public class Verify_ModifierSale_Report {
	...
	else
	{
		...
		driver.close();
			...
			@Test(priority=80)
			public void Modifier_Sale_method_openpage_Report() throws Exception
			{
			...
			@Test(priority=81)
			public void Modifier_Sale_method_Report_For_Specific_Date() throws Exception
			{
				Thread.sleep(2000);
		...
		/*		        //Print number of Rows
			...
			@Test(priority=82)
			public void Modifier_Sale_method_Report_For_Specific_Date_With_Quantity_Sort() throws Exception
			{
				Thread.sleep(2000);
				WebElement html = driver.findElement(By.tagName("html"));
				html.sendKeys(Keys.chord(Keys.CONTROL, Keys.SUBTRACT));
		...
		/*		        //Print number of Rows
			...
			@Test(priority=83)
			public void Modifier_Sale_method_Report_For_Specific_Date_With_Dynamic_Report() throws Exception
			{
				Thread.sleep(2000);
				WebElement html = driver.findElement(By.tagName("html"));
				html.sendKeys(Keys.chord(Keys.CONTROL, Keys.SUBTRACT));
			...
			@Test(priority=84)
			public void Modifier_Sale_method_Report_For_Specific_Date_With_Quantity_Sort_And_Dynamic_Report() throws Exception
			{
				Thread.sleep(2000);
