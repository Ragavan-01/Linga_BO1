...
public void flushTest() throws Exception
{
	...
	rep.flush();
			...
			public void Employee_Role_Based_Payroll_Report_Method_Page_Open() throws Exception
		{
	/*		//Click the Reports option
			...
			public void Employee_Role_Based_Payroll_Report_Method_verifyDailyReport() throws Exception
			{
	...
	/*							ArrayList<String> obtainedList = new ArrayList<>(); 
			...
			public void Employee_Role_Based_Payroll_Report_Method_verifyWeeklyReport() throws Exception
			{
