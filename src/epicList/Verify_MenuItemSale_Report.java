...
public class Verify_MenuItemSale_Report {
	...
	else
	{
		...
		driver.close();
			...
			public void Menu_Item_Sale_method_openpage_Report() throws Exception
			{
			...
			public void Menu_Item_Sale_method__Report_For_Specific_Date() throws Exception
			{
				Thread.sleep(2000);
		...
		/*		        //Print number of Rows
			...
			public void Menu_Item_Sale_method__Report_For_Specific_Date_With_Quantity_Sort() throws Exception
			{
				Thread.sleep(2000);
				WebElement html = driver.findElement(By.tagName("html"));
				html.sendKeys(Keys.chord(Keys.CONTROL, Keys.SUBTRACT));
		...
		/*		        //Print number of Rows
			...
			public void Menu_Item_Sale_method__Report_For_Specific_Date_With_Dynamic_Report_Without_Quantity_Sort() throws Exception
			{
				Thread.sleep(2000);
				WebElement html = driver.findElement(By.tagName("html"));
				html.sendKeys(Keys.chord(Keys.CONTROL, Keys.SUBTRACT));
			...
			public void Menu_Item_Sale_method__Report_For_Specific_Date_With_Quantity_Sort_And_Dynamic_Report() throws Exception
			{
				Thread.sleep(2000);
				WebElement html = driver.findElement(By.tagName("html"));
