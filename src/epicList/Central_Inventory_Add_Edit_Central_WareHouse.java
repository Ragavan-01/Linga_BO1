...
public class Central_Inventory_Add_Edit_Central_WareHouse {
	...
	@Test(priority=2)
	public void Central_WareHouse_openpage() throws Exception
	{
/*		Thread.sleep(15000);
	...
	@Test(priority=3)
	public void Central_WareHouse_Creation() throws Exception
	{
		Thread.sleep(2000);
	...
	@Test(priority=4)
	public void Central_WareHouse_Edit() throws Exception
	{
	...
	@Test(priority=5)
	public void Central_WareHouse_Dashboard() throws Exception
	{
	...
	@Test(priority=6)
	public void Central_warehouse_Reports() throws Exception
	{
			Thread.sleep(4000);
