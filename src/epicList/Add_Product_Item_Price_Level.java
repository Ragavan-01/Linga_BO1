...
public class Add_Product_Item_Price_Level {
	...
	@Test(priority=2)
	public void openProductsItems() throws Exception
	{
	...
	public void refreshMenuItemPage() throws InterruptedException
	{
		Thread.sleep(5000);
	...
	public void addMenuItem() throws Exception
	{
		...
		//Enter the Name
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div/div/div/div/div/div[2]/div[4]/div/div[2]/div[2]/form/div/ng-form/div[1]/div[2]/div/input")).sendKeys(Utility.getProperty("ProductsItems_Name"));
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div/div/div/div/div/div[2]/div[4]/div/div[2]/div[2]/form/div/ng-form/div[1]/div[3]/div/input")).sendKeys(Utility.getProperty("ProductsItems_SecName"));
		Thread.sleep(1000);
	...
	public void editMenuItem() throws Exception
	{
		...
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[3]/div/div/div/div[2]/div[1]/div[2]/label/input")).sendKeys(Utility.getProperty("ProductsItems_Name"));
		//Click the Edit icon
		...
		String amt1 = upAmt1.getAttribute("value").replaceAll("[a-zA-Z $ ₹ , :]", "").replaceAll("[a-zA-Z $ ₹ , :]", "");
	...
	public void editExistingMenuItem_Single_Serving_Size() throws Exception
	{
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		Thread.sleep(3000);
		...
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[3]/div/div/div/div[2]/div[1]/div[2]/label/input")).clear();
		//Enter the required keyword
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[3]/div/div/div/div[2]/div[1]/div[2]/label/input")).sendKeys(Utility.getProperty("Prizing_Level_Existing_Menu_Item"));
		//Click the Edit icon
		driver.findElement(By.cssSelector("i.fa.fa-pencil")).click();
		Thread.sleep(5000);
	...
	@Test(priority=7)
	public void editExistingMenuItem_Multiple_Serving_Size() throws Exception
	{
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		Thread.sleep(3000);
		...
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[3]/div/div/div/div[2]/div[1]/div[2]/label/input")).clear();
		//Enter the required keyword
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[3]/div/div/div/div[2]/div[1]/div[2]/label/input")).sendKeys(Utility.getProperty("Prizing_Level_Existing_Menu_Item_MultipleSSL"));
		//Click the Edit icon
		driver.findElement(By.cssSelector("i.fa.fa-pencil")).click();
