...
public class AddEditDelete_TaxExemptReasons {
	...
	@Test(priority=81)
	public void Reasons_TaxExempt_method_openTaxExemptReasons() throws Exception
	{
	...
	@Test(priority=82)
	public void Reasons_TaxExempt_method_refreshTaxExemptReasons() throws InterruptedException
	{
		Thread.sleep(5000);
		//Click the refresh button
	...
	@Test(priority=84)
	public void Reasons_TaxExempt_method_addTaxExemptReasons() throws Exception
	{
		for (int i = 0; i < 10; i++) {
	...
	@Test(priority=85)
	public void Reasons_TaxExempt_method_editTaxExemptReasons() throws Exception
	{
		Thread.sleep(3000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	@Test(priority=86)
	public void Reasons_TaxExempt_method_deleteTaxExemptReasons() throws Exception
	{
		Thread.sleep(5000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	@Test(priority=87)
	public void Reasons_TaxExempt_method_closeButton() throws Exception
	{
		Thread.sleep(5000);
		//Click the Active Button
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[3]/div[1]/div/div/div[2]/div[1]/div[1]/input")).click();
	...
	@Test(priority=88)
	public void Reasons_TaxExempt_method_verifyActive_InActiveButton() throws Exception
	{
		Thread.sleep(3000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
