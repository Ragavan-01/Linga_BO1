...
public class Sort_Menu_Config_Ascending {
	public WebDriver driver;
	
	ExtentReports rep = ExtentManager.getInstance();
	ExtentTest test = rep.startTest("Sort_Menu_Config_Ascending");
	...
	@Test(priority=2)
	public void Sort_Menu_Config_Ascending_method_openSortMenuConfig() throws Exception
	{
		Thread.sleep(15000);
/*		//Click the Products/Items option
	...
	@Test(priority=3)
	public void Sort_Menu_Config_Ascending_method_sortByAscendingOrder_Category() throws Exception
	{
		Thread.sleep(3000);
	...
	@Test(priority=5)
	public void Sort_Menu_Config_Ascending_method_sortByAscendingOrder_Subctegory() throws Exception
	{
		Thread.sleep(3000);
		Actions actions = new Actions(driver);
		WebElement showCategory = driver.findElement(By.xpath("html/body/div[1]/div[1]/div/div[2]/div[2]/div/div/div[2]/div[2]/div[1]/div/div/div[1]"));
	...
	@Test(priority=4)
	public void Sort_Menu_Config_Ascending_method_sortByAscendingOrder_MenuItem() throws Exception
	{
	...
	@Test(priority=6)
	public void Sort_Menu_Config_Ascending_method_closeButton() throws Exception
	{
		Thread.sleep(3000);
		Actions actions = new Actions(driver);
		//Create the webelement for the Category field
