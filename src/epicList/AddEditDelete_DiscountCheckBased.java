...
public class AddEditDelete_DiscountCheckBased {
	...
	@Test(priority=61)
	public void Check_Based_Discount_method_openDiscount_CheckBasedPage() throws Exception
	{
/*		//Click the Products/Items option
	...
	@Test(priority=62)
	public void Check_Based_Discount_method_refreshDiscount_CheckBasedPage() throws InterruptedException
	{
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	...
	@Test(priority=64)
	public void Check_Based_Discount_method_addDiscount_CheckBased() throws Exception
	{
		for (int i = 0; i < 10; i++) {
			driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
			driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
	...
	@Test(priority=65)
	public void Check_Based_Discount_method_editDiscount_CheckBased() throws Exception
	{
		Thread.sleep(3000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	@Test(priority=66)
	public void Check_Based_Discount_method_deleteDiscount_CheckBased() throws Exception
	{
		Thread.sleep(3000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	@Test(priority=67)
	public void Check_Based_Discount_method_cancelButton() throws Exception
	{
		Thread.sleep(5000);
		//Click on the Add Menu Item option
		driver.findElement(By.id("newDiscount")).click();
	...
	@Test(priority=68)
	public void Check_Based_Discount_method_editDiscount_CheckBased_TimePeriodAsAlways_SaveAndPublish() throws Exception
	{
	...
	@Test(priority=69)
	public void Check_Based_Discount_method_editDiscount_CheckBased_TimePeriodAsDaysOfMonth() throws Exception
	{
		Thread.sleep(3000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
...
//		Thread.sleep(7000);driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	...
	@Test(priority=70)
	public void Check_Based_Discount_method_editDiscount_CheckBased_TimePeriodasDateRange() throws Exception
	{
		Thread.sleep(5000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
...
/*		//Click the Exclude Category field
	...
	@Test(priority=71)
	public void Check_Based_Discount_method_editDiscount_CheckBased_TimePeriodAsSpecificDate() throws Exception
	{
		Thread.sleep(3000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
...
/*		//Click the Exclude Category field
	...
	@Test(priority=72)
	public void Check_Based_Discount_method_editDiscount_CheckBased_TimePeriodAsStartDateTimeAndEndDateTime() throws Exception
	{
		Thread.sleep(3000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
...
/*		//Click the Exclude Category field
	...
	@Test(priority=73)
	public void Check_Based_Discount_method_verifyActive_InActiveButton() throws Exception
	{
		Thread.sleep(15000);
...
/*	@Test(priority=63)
	public void Check_Based_Discount_method_pagination() throws InterruptedException
	{
		Thread.sleep(3000);
...
*/	
	@Test(priority=74)
	public void Check_Based_Discount_method_addSameName() throws Exception
	{
		Thread.sleep(5000);
		//Click on the Add Menu Item option
		driver.findElement(By.id("newDiscount")).click();
