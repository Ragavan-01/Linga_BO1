...
public class Verify_Void_Transaction_Report {
	...
	public void flushTest() throws Exception
	{
		...
		rep.flush();
			...
			public void Void_Transaction_Report_Method_openpage() throws Exception
			{
				/*
				Thread.sleep(2000);
			...
			public void Void_Transaction_Report_Method__For_Tender_Type() throws Exception
			{
			...
			public void Void_Transaction_Report_Method__For_Tender_Name() throws Exception
			{
