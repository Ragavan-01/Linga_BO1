...
public class AddEditDelete_Enterprise_Customers {
	
	public WebDriver driver;
	
	ExtentReports rep = ExtentManager.getInstance();
	ExtentTest test = rep.startTest("AddEditDelete_Enterprise_Customers");
	...
	public void flushTest() throws Exception
	{
		...
		@Test(priority=16)
		public void Enterprise_Customers_openpage() throws Exception
		{
		...
		@Test(priority=17)
		public void Enterprise_Customer_add_() throws Exception
		{
			Thread.sleep(2000);
		...
		@Test(priority=18)
		public void Enterprise_Customer_edit() throws Exception
		{
			Thread.sleep(2000);
			//Clear the search field
			driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
		...
		@Test(priority=21)
		public void Enterprise_Customer_delete() throws Exception
		{
			Thread.sleep(2000);
			//Clear the search field
			driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	/*		//Click the Active Button
		...
		@Test(priority=19)
		public void Enterprise_Customer_cancelButton() throws Exception
		{
			Thread.sleep(2000);
			//Clear the search field
			driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
		...
		@Test(priority=20)
		public void Enterprise_Customer_view_page() throws Exception
		{
			Thread.sleep(2000);
			//Clear the search field
			driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
