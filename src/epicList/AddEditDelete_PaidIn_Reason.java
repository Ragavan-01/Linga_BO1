...
public class AddEditDelete_PaidIn_Reason {
	...
	@Test(priority=121)
	public void Reasons_PaidIn_method_openPaidInReasons() throws Exception
	{
	...
	@Test(priority=122)
	public void Reasons_PaidIn_method_refreshPaidInReasons() throws InterruptedException
	{
		Thread.sleep(5000);
		//Click the refresh button
	...
	@Test(priority=124)
	public void Reasons_PaidIn_method_addPaidInReasons() throws Exception
	{
		for (int i = 0; i < 10; i++) {
	...
	@Test(priority=125)
	public void Reasons_PaidIn_method_editPaidInReasons() throws Exception
	{
		Thread.sleep(5000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	@Test(priority=126)
	public void Reasons_PaidIn_method_deletePaidInReasons() throws Exception
	{
		Thread.sleep(5000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	@Test(priority=127)
	public void Reasons_PaidIn_method_closeButton() throws Exception
	{
		Thread.sleep(5000);
		//Click the Active Button
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[3]/div[1]/div/div/div[2]/div[1]/div[1]/input")).click();
	...
	@Test(priority=128)
	public void Reasons_PaidIn_method_verifyActive_InActiveButton() throws Exception
	{
		Thread.sleep(3000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
