...
public class AddEditDelete_Modifiers {
	...
	public void flushTest() throws Exception
	{
		...
		@Test(priority=121)
		public void Modifiers_method_openModifiers() throws Exception
		{
	/*		//Click the Products/Items option
		...
		@Test(priority=122)
		public void Modifiers_method_refreshModifiers_Page() throws InterruptedException
		{
			Thread.sleep(5000);
			//Click the refresh button
		...
		@Test(priority=124)
		public void Modifiers_method_add_Modifiers() throws Exception
		{
			for (int i = 0; i < 10; i++) {
		...
		@Test(priority=125)
		public void Modifiers_method_edit_Modifiers() throws Exception
		{
		...
		@Test(priority=126)
		public void Modifiers_method_delete_Modifier() throws Exception
		{
			Thread.sleep(3000);
			//Clear the Search field
			driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
		...
		@Test(priority=127)
		public void Modifiers_method_cancelModifier_BasicDetails() throws Exception
		{
			Thread.sleep(3000);
			//Clear the Search field
			driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
		...
		@Test(priority=128)
		public void Modifiers_method_cancelModifier_Prefixes() throws Exception
		{
			Thread.sleep(3000);
			//Clear the Search field
			driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
		...
		@Test(priority=129)
		public void Modifiers_method_add_Modifiers_Save_BasicDetails() throws Exception
		{
			Thread.sleep(3000);
			//Click the Add Modifiers button
			driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[1]/div/div/div/a[2]")).click();
		...
		@Test(priority=130)
		public void Modifiers_method_inactiveAndActive_Button() throws Exception
		{
			Thread.sleep(3000);
