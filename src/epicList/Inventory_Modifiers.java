...
public class Inventory_Modifiers {
	...
	ExtentTest test = rep.startTest("Inventory_Modifiers");
		...
		@Test(priority=2)
		public void Inventory_Modifier_HomePage() throws Exception
		{
			Thread.sleep(15000);
			//Get the URl
		...
		@Test(priority=4)
		public void Inventory_Modifier() throws Exception
		{
		Thread.sleep(3000);
		//Clear the Search 
		...
		@Test(priority=5)
		public void Inventory_Modifier_Item_Update() throws Exception
		{
			Thread.sleep(3000);
			//Click the Item Type
		...
		@Test(priority=6)
		public void Inventory_Modifier_new_item_modifiers_Update() throws Exception
		{
		...
		@Test(priority=7)
		public void Inventory_Modifier_SubRecipe_Update() throws Exception
		{
			Thread.sleep(2000);
			//Clear the Search 
			driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div/div/div/div[3]/div[2]/div[1]/div[2]/label/input")).clear();
		...
		@Test(priority=8)	
		public void Inventory_Modifier__Add_Invetory_Sub_Recipe() throws Exception	
		...
		@Test(priority=9)	
		public void Inventory_Modifier__Add_Invetory_Menu_Item() throws Exception	
		...
		@Test(priority=10)	
		public void Inventory_Modifier__Add_Not_an_InventoryItem() throws Exception	
