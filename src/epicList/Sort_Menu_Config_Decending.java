...
public class Sort_Menu_Config_Decending {
	
	public WebDriver driver;
	
	
	ExtentReports rep = ExtentManager.getInstance();
	ExtentTest test = rep.startTest("Sort_Menu_Config_Decending");
	...
	@Test(priority=11)
	public void Sort_Menu_Config_Decending_method_openSortMenuConfig() throws Exception
	{
	...
	@Test(priority=12)
	public void Sort_Menu_Config_Decending_method_sortByDecendingOrder() throws Exception
	{
		Thread.sleep(3000);
	...
	@Test(priority=14)
	public void Sort_Menu_Config_Decending_method_sortByDecendingOrder_Subctegory() throws Exception
	{
		Thread.sleep(3000);
		Actions actions = new Actions(driver);
	...
	@Test(priority=13)
	public void Sort_Menu_Config_Decending_method_sortByDecendingOrder_MenuItem() throws Exception
	{
