...
public class Printer_Reroute {
	...
	@Test(priority=2)
	public void Printer_Reroute_Open_Printer_Reroute() throws Exception
	{
	...
	@Test(priority=3)
	public void Printer_Reroute_refresh_Page() throws InterruptedException
	{
		Thread.sleep(5000);
		//Click the refresh button
	...
	@Test(priority=4)
	public void Printer_Reroute_pagination() throws InterruptedException
	{
	...
	@Test(priority=5)
	public void Printer_Reroute_Add_Printer_Reroute_By_Node() throws Exception
	{
		for(int i = 0; i <= 10; i++)
		{
	...
	@Test(priority=6)
	public void Printer_Reroute_Edit_Printer_Reroute_By_Node_Days_Of_Week() throws Exception
	{
...
/*		Thread.sleep(1500);
	...
	@Test(priority=7)
	public void Printer_Reroute_Edit_Printer_Reroute_By_Node_Days_Of_Month() throws Exception
	{
		Thread.sleep(5000);
		//Clear the Search button
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
...
/*		//Enable or Disable the Set Time option
	...
	@Test(priority=8)
	public void Printer_Reroute_Edit_Printer_Reroute_By_Node_Date_Range() throws Exception
	{
		Thread.sleep(8000);
		//Clear the Search button
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
...
/*		driver.findElement(By.xpath("//span[contains(.,'Set time')]")).click();
	...
	@Test(priority=9)
	public void Printer_Reroute_Edit_Printer_Reroute_By_Node_Specific_Date() throws Exception
	{
		Thread.sleep(5000);
		//Clear the Search button
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	@Test(priority=10)
	public void Printer_Reroute_Edit_Printer_Reroute_By_Node_Start_Date_And_End_Date_Time() throws Exception
	{
		Thread.sleep(5000);
		//Clear the Search button
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	@Test(priority=10)
	public void Printer_Reroute_Same_From_And_TO_Printer() throws Exception
	{
		Thread.sleep(5000);
		//Clear the Search button
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
...
/*		driver.findElement(By.xpath("//span[contains(.,'Set time')]")).click();
	...
	@Test(priority=11)
	public void Printer_Reroute_Delete_Printer_Reroute_By_Node() throws Exception
	{
		Thread.sleep(5000);
		//Clear the Search button
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	@Test(priority=12)
	public void Printer_Reroute_Add_Printer_Reroute_By_Role() throws Exception
	{
		for(int i = 0; i <= 10; i++)
		{
			driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
	...
	@Test(priority=13)
	public void Printer_Reroute_Edit_Printer_Reroute_By_Role_Days_Of_Week() throws Exception
	{
		Thread.sleep(5000);
		//Clear the Search button
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
...
/*		driver.findElement(By.xpath("//span[contains(.,'Set time')]")).click();
	...
	@Test(priority=14)
	public void Printer_Reroute_Edit_Printer_Reroute_By_Role_Days_Of_Month() throws Exception
	{
		Thread.sleep(5000);
		//Clear the Search button
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
...
/*		driver.findElement(By.xpath("//span[contains(.,'Set time')]")).click();
	...
	@Test(priority=15)
	public void Printer_Reroute_Edit_Printer_Reroute_By_Role_Date_Range() throws Exception
	{
		Thread.sleep(5000);
		//Clear the Search button
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
...
/*		driver.findElement(By.xpath("//span[contains(.,'Set time')]")).click();
	...
	@Test(priority=16)
	public void Printer_Reroute_Edit_Printer_Reroute_By_Role_Specific_Date() throws Exception
	{
		Thread.sleep(5000);
		//Clear the Search button
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	@Test(priority=17)
	public void Printer_Reroute_Edit_Printer_Reroute_By_Role_Start_Date_And_End_Date_Time() throws Exception
	{
		Thread.sleep(5000);
		//Clear the Search button
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	@Test(priority=18)
	public void Printer_Reroute_Delete_Printer_Reroute_By_Role() throws Exception
	{
		Thread.sleep(5000);
		//Clear the Search button
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	@Test(priority=19)//19
	public void Printer_Reroute_Verify_Kitchen_KDS_Available_Or_Not() throws Exception
	{
		Thread.sleep(5000);
