...
public class AddEditDelete_GiftCard {
	...
	@Test(priority=41)
	public void Giftcard_method_openGiftCard() throws Exception
	{
	...
	@Test(priority=42)
	public void Giftcard_method_refreshGiftCard() throws InterruptedException
	{
		Thread.sleep(5000);
		//Click the refresh button
	...
	@Test(priority=44)
	public void Giftcard_method_addGiftCard() throws Exception
	{
		for (int i = 0; i < 10; i++) {
	...
	@Test(priority=45)
	public void Giftcard_method_editGiftCard() throws Exception
	{
		Thread.sleep(6000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	@Test(priority=46)
	public void Giftcard_method_deleteGiftCard() throws Exception
	{
		Thread.sleep(5000);
		//Clear the search field
		driver.findElement(By.xpath("//input[@ng-model='searchText']")).clear();
	...
	@Test(priority=47)
	public void Giftcard_method_cancelButton() throws Exception
	{
     Thread.sleep(5000);
	...
	@Test(priority=48)
	public void Giftcard_method_sameName() throws Exception
	{
	...
	@Test(priority=49)
	public void Giftcard_method_recharge() throws Exception
	{
