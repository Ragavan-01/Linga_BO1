...
public class Inventory_Items {
	...
	public void flushTest() throws Exception
	{
		...
		@Test(priority=37)
		public void Inventory_Items_openpage() throws Exception
		{
		...
		@Test(priority=38)
		public void Inventory_Items_refresh() throws InterruptedException
		{
		...
		@Test(priority=39)
		public void Inventory_item_pagination() throws InterruptedException
		{
		...
		@Test(priority=40)
		public void Inventory_Items_add() throws Exception
		{
			driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
			driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
			Thread.sleep(5000);
		...
		@Test(priority=41)
		public void Inventory_Items_edit_Inventory_Items() throws Exception
		{
			driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
			driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
			Thread.sleep(3000);
		...
		@Test(priority=42)
		public void Inventory_Items_delete() throws Exception
		{
		...
		@Test(priority=43)
		public void Inventory_Items_closeButton() throws Exception
		{
			driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
			driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
			Thread.sleep(3000);
		...
		@Test(priority=44)
		public void Inventory_Items_verifyActive_InActiveButton() throws Exception
		{
			driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
			driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
			Thread.sleep(3000);
