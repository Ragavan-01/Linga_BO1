...
public class Verify_Driver_Report {
	...
	public void flushTest() throws Exception
	{
		...
		@Test(priority=2)
		public void Driver_Report_Method_Openpage() throws Exception
		{
			Thread.sleep(15000);
...
*/			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id")+"driverReport");
			Thread.sleep(5000);
		...
		@Test(priority=3)
		public void Driver_Report_Method_verify() throws Exception
		{
