...
public class Verify_Till_Reports {
	...
	@Test(priority=2)
	public void viewTillReportAll() throws Exception
	{
	...
	@Test(priority=3)
	public void verifyTillReportAll() throws Exception
	{
...
/*		String[] date = new String[rows.size()];
	...
	@Test(priority=4)
	public void verifyTillReportGlobal() throws Exception
	{
	...
	@Test(priority=5)
	    public void verifyTillReportUser() throws Exception
	    {
			Thread.sleep(3000);
