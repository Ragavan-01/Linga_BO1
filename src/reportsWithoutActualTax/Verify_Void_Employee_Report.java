...
public class Verify_Void_Employee_Report {
	...
	@Test(priority=2)
	public void open_Void_Employee_Report() throws Exception
	{
		...
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[1]/div/div/div/scrollable-tabset/div/div/div/ul/li[2]/a/uib-tab-heading/span")).click();
	...
	public void void_Node_Report() throws Exception
	{
		...
		else if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[5]/div/table/tbody/tr[2]/td[1]")).getText() != null && driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[5]/div/table/tbody/tr[2]/td[5]")).getText() != null)
		{
			
			test.log(LogStatus.PASS, "Void Employee Report is available for Specific Date");
			
			//Get the number of rows
			List<WebElement> rows = driver.findElements(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[5]/div/table/tbody/tr"));
			
			//Get the Quantity value
			String quantity = driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[5]/div/table/tbody/tr["+rows.size()+"]/td[4]")).getText();
			...
			String amount = driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[5]/div/table/tbody/tr["+rows.size()+"]/td[5]")).getText();
			...
			//Get the Tax value
			String tax = driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[5]/div/table/tbody/tr["+rows.size()+"]/td[6]")).getText();
			...
			String discount = driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[5]/div/table/tbody/tr["+rows.size()+"]/td[8]")).getText();
