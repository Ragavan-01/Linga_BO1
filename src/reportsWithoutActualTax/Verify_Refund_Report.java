...
public class Verify_Refund_Report {
	...
	@Test(priority=2)
	public void viewRefundReport() throws Exception
	{
	...
	@Test(priority=3)
	public void verifyRefundReport_By_Payment_Type() throws Exception
	{
	...
	@Test(priority=4)
	public void verifyRefundReport_By_Payment_Name() throws Exception
	{
