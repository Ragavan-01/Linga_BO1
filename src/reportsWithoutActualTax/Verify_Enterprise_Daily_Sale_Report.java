...
public class Verify_Enterprise_Daily_Sale_Report {
	...
	@Test(priority=2)
	public void open_Enterprise_Daily_Report() throws Exception
	{
		...
		Thread.sleep(2000);
		//Click the Daily Sale option
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[1]/div/div/div/div/scrollable-tabset/div/div/div/ul/li[8]/a/uib-tab-heading/span")).click();
	...
	@Test(priority=4)
	public void view_Enterprise_Daily_Sale_Report_Stores() throws Exception
	{
	...
	@Test(priority=5)
	public void view_Enterprise_Daily_Sale_Report_Group() throws Exception
	{
	...
	@Test(priority=6)
	public void view_Enterprise_Daily_Sale_Report_City() throws Exception
	{
	...
	@Test(priority=7)
	public void view_Enterprise_Daily_Sale_Report_State() throws Exception
	{
	...
	@Test(priority=8)
	public void view_Enterprise_Daily_Sale_Report_ZipCode() throws Exception
	{
