...
public class Verify_Enterprise_Weekly_Summary_Report {
	...
	@Test(priority=2)
	public void open_Enterprise_Weekly_Report() throws Exception
	{
		...
		Thread.sleep(2000);
		//Click the Weekly Sale option
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[1]/div/div/div/div/scrollable-tabset/div/div/div/ul/li[11]/a/uib-tab-heading/span")).click();
	...
	public void weekly_Summary_Report_This_Week() throws Exception
	{
		...
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[1]/div/form/div[1]/div/div/div/div/input")).sendKeys("Store 01");
		//Press the Enter Key
