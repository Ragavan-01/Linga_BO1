...
public class Verify_MenuItemSale_Report {
	...
	@Test(priority=2)
	public void open_MenuItem_Sale_Report() throws Exception
	{
		...
		//Click the Menu Item Sale Report Option
		driver.findElement(By.xpath("//span[.=' Menu Item Sale ']")).click();
	...
	@Test(priority=12)
	public void menuItem_Sale_Report_For_Specific_Date() throws Exception
	{
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		//Enable or Disable the Split by Serving Level
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[1]/div/form/div[5]/div/div/input")).click();
		
		Thread.sleep(3000);
		//Click the Employee option
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[1]/div/form/div[6]/div/div/a")).click();
		//Enter the required Employee
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[1]/div/form/div[6]/div/div/div/div/input")).sendKeys("All");
		//Press the Enter Key
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[1]/div/form/div[6]/div/div/div/div/input")).sendKeys(Keys.ENTER);
		...
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[1]/div/form/div[7]/div/div/div/div/input")).sendKeys("Date Range");
		//Press the Enter Key
		...
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[1]/div/form/div[8]/div/div/input[1]")).clear();
		//Enter the date
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[1]/div/form/div[8]/div/div/input[1]")).sendKeys(Utility.getReportProperty("Date_Range_From"));
		
		Thread.sleep(2000);
		//Clear the date field
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[1]/div/form/div[8]/div/div/input[2]")).clear();
		//Enter the date
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[1]/div/form/div[8]/div/div/input[2]")).sendKeys(Utility.getReportProperty("Date_Range_To"));
