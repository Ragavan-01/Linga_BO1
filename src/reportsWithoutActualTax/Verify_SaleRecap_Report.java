...
public class Verify_SaleRecap_Report {
	...
	@Test(priority=2)
	public void open_Sale_Recap_Report() throws Exception
	{
		...
		//Click the Sale Recap Report
		driver.findElement(By.xpath("//span[.=' Sale Recap']")).click();
		Thread.sleep(3000);
	...
	@Test(priority=3)
	public void sale_Recap_Report() throws Exception
	{
