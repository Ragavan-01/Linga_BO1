...
public class Verify_Enterprise_Cashier_Out_Report {
	...
	@Test(priority=2)
	public void open_Enterprise_CashierOut_Report() throws Exception
	{
		...
		Thread.sleep(2000);
		//Click the CashierOut Sale option
		driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[1]/div/div/div/div/scrollable-tabset/div/div/div/ul/li[10]/a/uib-tab-heading/span")).click();
	...
	@Test(priority=4)
	public void view_Enterprise_CashierOut_Report() throws Exception
	{
