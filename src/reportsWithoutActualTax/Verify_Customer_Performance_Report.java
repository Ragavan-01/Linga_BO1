...
public class Verify_Customer_Performance_Report {
	...
	@Test(priority=2)
	public void viewCustomerPerformanceReport() throws Exception
	{
	...
	@Test(priority=3)
	public void verifyCustomerPerformanceReport() throws Exception
	{
	...
	@Test(priority=4)
	public void verifyCustomerPerformanceReportWithoutCategorySubcategoryAdnServingSize() throws Exception
	{
		Thread.sleep(5000);
