...
public class Verify_Void_Transaction_Report {
	...
	@Test(priority=2)
	public void open_Void_Transaction_Report() throws Exception
	{
		...
		//Click the Void Transaction option
		driver.findElement(By.xpath("//span[.=' Void Transaction ']")).click();
	...
	@Test(priority=3)
	public void void_Transaction_Report_For_Tender_Type() throws Exception
	{
