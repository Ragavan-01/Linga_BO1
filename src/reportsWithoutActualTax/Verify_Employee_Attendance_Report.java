...
public class Verify_Employee_Attendance_Report {
	...
	@Test(priority=2)
	public void viewEmployeeAttendanceReport() throws Exception
	{
	...
	@Test(priority=3)
	public void attendance_Report_For_InTime() throws Exception
	{
		Thread.sleep(5000);
	    ...
	    driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[1]/div/form/div[4]/div/div/div/div/input")).sendKeys("In Time");
	    //Press the Enter key
	...
	@Test(priority=4)
	public void attendance_Report_For_InHours() throws Exception
	{
		Thread.sleep(5000);
		//Select the Employee option
	    driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[1]/div/form/div[1]/div/div/a")).click();
	    ...
	    driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[1]/div/form/div[4]/div/div/a")).click();
	    //Enter the required Format
	    driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[1]/div/form/div[4]/div/div/div/div/input")).sendKeys("In Hours");
	    //Press the Enter key
	    driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[1]/div/form/div[4]/div/div/div/div/input")).sendKeys(Keys.ENTER);
