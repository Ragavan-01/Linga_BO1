...
public class Verify_SubCategorySale_Report {
	...
	@Test(priority=2)
	public void open_SubCategory_Sale_Report() throws Exception
	{
		...
		//Click the Sub Category Sale Report Option
		driver.findElement(By.xpath("//span[.=' Sub Category sale']")).click();
	...
	@Test(priority=12)
	public void subCategory_For_Specific_Date() throws Exception
	{
		Thread.sleep(2000);
...
/*		        //Print number of Rows
		        ...
		        if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/table/tbody/tr["+rows.size()+"]/td[2]/span")).getText().equals(Utility.getReportProperty("Sub_Category_Sale_Report_Sale_Amount")))
		        {
		        ...
		        if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/table/tbody/tr["+rows.size()+"]/td[3]/span")).getText().equals(Utility.getReportProperty("Sub_Category_Sale_Report_Quantity")))
		        {
		        ...
		        if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/table/tbody/tr["+rows.size()+"]/td[4]/span")).getText().equals(Utility.getReportProperty("Sub_Category_Sale_Report_Tax")))
		        {
		        ...
		        if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/table/tbody/tr["+rows.size()+"]/td[5]/span")).getText().equals(Utility.getReportProperty("Sub_Category_Sale_Report_Discount")))
		        {
		        ...
		        if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/table/tbody/tr["+rows.size()+"]/td[6]/span")).getText().equals(Utility.getReportProperty("Sub_Category_Sale_Report_Percentage_Of_Sale")))
		        {
