...
public class Settings_Wait_List 
{
	...
	public void Wait_List_Settings_Method_open(WebDriver driver) throws Exception
	{
		...
		ExcelDataConfig excel = new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
			...
			Thread.sleep(3000);
			//Enter the URL
			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id")+"newWaitList");
		...
		ExcelDataConfig excel = new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
		  ...
		  //Check weather the new form loaded or not
			...
			driver.findElement(By.xpath("//button[@type='submit']")).click();
			 ...
			 //check the alert message
			Thread.sleep(2000);
		    if(driver.findElement(By.xpath("//span[contains(.,'already occupied')]")).isDisplayed())
		    {
