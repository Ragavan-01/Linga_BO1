...
public class Inventory_Transfer_Request {
	...
	ExtentTest test = rep.startTest("Inventory_Transfer_Request");
		...
		driver.findElement(By.xpath(excel.getData(3, 1704, 1))).click();
		Thread.sleep(2000);
		//Click Destination field to select store
		driver.findElement(By.xpath(excel.getData(3, 1705, 1))).sendKeys(Utility.getProperty("Inventory_Menuconfic_From_CentralWareHouse"));
		//Click Destination field to select store
		driver.findElement(By.xpath(excel.getData(3, 1705, 1))).sendKeys(Keys.ENTER);
