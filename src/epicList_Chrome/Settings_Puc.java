...
import newReadExcelFile_New.ExcelDataConfig;
	...
	public class Settings_Puc {
			...
			float unknownValue = 00;
				...
				public void PLU_Settings_Method_open(WebDriver driver2) throws Exception {
					ExcelDataConfig excel = new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
					Thread.sleep(10000);
					//Enter the URL
					driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id")+"pucCabinet");
			...
			public void	PLU_Settings_Method_edit(WebDriver driver2) throws Exception 
			  {
				...
				if(driver.findElement(By.xpath(excel.getData(5, 544, 1))).isSelected())
				{
					...
					driver.findElement(By.xpath(excel.getData(5, 547, 1))).clear();
					//Enter valve into Cabinate Id
					driver.findElement(By.xpath(excel.getData(5, 547, 1))).sendKeys("1254");
					//Clear the existing Cabinate Alias
					driver.findElement(By.xpath(excel.getData(5, 548, 1))).clear();
					//Enter valve into Cabinate alias
					driver.findElement(By.xpath(excel.getData(5, 548, 1))).sendKeys("1289");
					//Update Button
					driver.findElement(By.xpath(excel.getData(5, 549, 1))).click();
					driver.findElement(By.tagName(excel.getData(5, 174, 5))).sendKeys(Keys.HOME);
					Thread.sleep(1000);
