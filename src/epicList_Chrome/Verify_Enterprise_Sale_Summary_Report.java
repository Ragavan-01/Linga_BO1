			...
			try
			{
				...
				if(!driver.findElement(By.xpath(excel.getData(3, 704, 1))).isDisplayed())
				{
		        	...
		        	//Replace all commo's with empty space
				        ...
				        if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[6]/table/tbody/tr["+rows.size()+"]/td[6]/span")).getText().equals(Utility.getReportProperty("Sale_Report_Net_Sale")))
				        {
				        ...
				        if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[6]/table/tbody/tr["+rows.size()+"]/td[7]/span")).getText().equals(Utility.getReportProperty("Sale_Report_Tax")))
				        {
				        ...
				        if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[6]/table/tbody/tr["+rows.size()+"]/td[8]/span")).getText().equals(Utility.getReportProperty("Sale_Report_Inclusive_Tax")))
				        {
				        ...
				        if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[6]/table/tbody/tr["+rows.size()+"]/td[9]/span")).getText().equals(Utility.getReportProperty("CC_Service_Charge")))
				        {
				        ...
				        if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[6]/table/tbody/tr["+rows.size()+"]/td[10]/span")).getText().equals(Utility.getReportProperty("Sale_Report_Discount")))
				        {
				      ...
				      //Check weather the Gross Receipt Report is correct or not
				        if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[6]/table/tbody/tr["+rows.size()+"]/td[11]/span")).getText().equals(Utility.getReportProperty("Gross_Receipt")))
				        {
				       ...
				       /* //Get the Gross Receipt value
				        ...
				        //Check weather the Gross Receipt Report is correct or not
				        if(s.equals(Utility.getReportProperty("Gross_Receipt").replaceAll("[a-zA-Z $ â‚¹ , :]", "")))
				        {
				        	test.log(LogStatus.PASS, "Actual and Expected Sale Summary reports are same for Gross Receipt");
