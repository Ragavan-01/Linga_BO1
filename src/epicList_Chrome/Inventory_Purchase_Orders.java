...
public class Inventory_Purchase_Orders {
		...
		*/		
				...
				driver.findElement(By.xpath(excel.getData(3, 1225, 1))).sendKeys("Parotta");
				//Press the Enter button
		...
		/*		driver.findElement(By.xpath(excel.getData(3, 40, 1))).clear();
			...
			*/	
				...
				if(driver.findElement(By.xpath(excel.getData(3, 1229, 1))).getText().equalsIgnoreCase("CANCELED"))
				{
			...
			{   
				...
				driver.findElement(By.name(excel.getData(3, 1222, 3))).clear();
				//Enter the Required Date
				driver.findElement(By.name(excel.getData(3, 1222, 3))).sendKeys("21-Dec-2020");
		...
		/*		//Clear the CC Option
			...
			*/	
				...
				Thread.sleep(2500);
				//Check whether the order is placed or not
				if(driver.findElement(By.xpath(excel.getData(3, 39, 3))).getText().equalsIgnoreCase("Purchase order saved successfully!."))
				{
					test.log(LogStatus.PASS, "Purchase order saved Sucessfully");
				}
				else
		...
		/*		
			...
			*/	
				...
				driver.findElement(By.cssSelector(excel.getData(3, 1232, 4))).click();
				...
				Thread.sleep(1500);
				//Click the Receiving Order Option
				driver.findElement(By.cssSelector(excel.getData(3, 1232, 1))).click();
