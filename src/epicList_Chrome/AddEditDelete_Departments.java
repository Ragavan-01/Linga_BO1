...
*/			
		...
		//	driver.manage().timeouts().implicitlyWait(40,TimeUnit.SECONDS);
			...
			WebElement saveDept=driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[1]/div/span/span"));
		...
		//	driver.manage().timeouts().implicitlyWait(30,TimeUnit.SECONDS);
			...
			if(wait.until(ExpectedConditions.visibilityOf(saveDept)).getText().equalsIgnoreCase("Department Updated Successfully"))
			{
