...
/*		Thread.sleep(1000);		
	...
	*/
		...
		driver.findElement(By.xpath(excel.getData(3, 1722, 1))).sendKeys(Utility.getReportProperty("ConsumptionLog_FromDate"));
		...
		driver.findElement(By.xpath(excel.getData(3, 1723, 1))).sendKeys(Utility.getReportProperty("ConsumptionLog_ToDate"));
