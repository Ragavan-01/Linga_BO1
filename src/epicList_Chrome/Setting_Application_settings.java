	...
	public class Setting_Application_settings {
			...
			float unknownValue = 00;
				...
				public void Application_Settings_Method_open(WebDriver driver2) throws Exception 
				{
					Thread.sleep(5000);
					// TODO Auto-generated method stub
					ExcelDataConfig excel = new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
					//Enter the URL
					driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id")+"newStoreSettings");
	...
	driver.findElement(By.xpath(excel.getData(5, 425, 1))).click();					
					...
					Thread.sleep(1000);
					driver.findElement(By.xpath(excel.getData(5, 430, 1))).click();
					//Floating Tab
					...
					//Pos Custom Field 1
					driver.findElement(By.xpath(excel.getData(5, 433, 1))).click();
					driver.findElement(By.xpath(excel.getData(5, 434, 1))).sendKeys("Credit Card");
					driver.findElement(By.xpath(excel.getData(5, 434, 1))).sendKeys(Keys.ENTER);
					//pos Custom field 2
					driver.findElement(By.xpath(excel.getData(5, 435, 1))).click();
					driver.findElement(By.xpath(excel.getData(5, 436, 1))).sendKeys("Void");
					driver.findElement(By.xpath(excel.getData(5, 436, 1))).sendKeys(Keys.ENTER);
					
					//pos Custom field 3
					driver.findElement(By.xpath(excel.getData(5, 437, 1))).click();
					driver.findElement(By.xpath(excel.getData(5, 438, 1))).sendKeys("Search");
					driver.findElement(By.xpath(excel.getData(5, 438, 1))).sendKeys(Keys.ENTER);
					
					//pos Custom field 4
					driver.findElement(By.xpath(excel.getData(5, 439, 1))).click();
					driver.findElement(By.xpath(excel.getData(5, 440, 1))).sendKeys("Cash");
					driver.findElement(By.xpath(excel.getData(5, 440, 1))).sendKeys(Keys.ENTER);
					
					//pos Custom field 5
					driver.findElement(By.xpath(excel.getData(5, 441, 1))).click();
					driver.findElement(By.xpath(excel.getData(5, 442, 1))).sendKeys("Modify");
					driver.findElement(By.xpath(excel.getData(5, 442, 1))).sendKeys(Keys.ENTER);
					
					//pos Custom field 6
					driver.findElement(By.xpath(excel.getData(5, 443, 1))).click();
					driver.findElement(By.xpath(excel.getData(5, 444, 1))).sendKeys("Gift Card");
					driver.findElement(By.xpath(excel.getData(5, 444, 1))).sendKeys(Keys.ENTER);
