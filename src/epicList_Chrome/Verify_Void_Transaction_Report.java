		...
		public void calling() throws Exception
		{
			...
			public void Void_Transaction_Report_Method__For_Tender_Name(WebDriver driver) throws Exception
			{
				...
				catch(Exception ds)
				{
					...
					//Get the Total amount value
					String Total_Amount = driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[5]/table/tbody/tr["+rows.size()+"]/td[10]")).getText().replaceAll("[a-zA-Z $ ₹ , :]", "");
