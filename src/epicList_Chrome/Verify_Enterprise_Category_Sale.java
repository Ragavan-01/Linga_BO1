...
public class Verify_Enterprise_Category_Sale {
	...
	ExtentTest test = rep.startTest("Verify_Enterprise_Category_Sale");
	...
	float unknownValue = 00;
		...
		public void calling() throws Exception
		{
			...
			Thread.sleep(1000);
			Enterprise_Category_Report_Method_For_openpage(driver);
			Enterprise_Category_Report_Method_For_Stores(driver);
			Enterprise_Category_Report_Method_For_Group(driver);
			Enterprise_Category_Report_Method_For_City(driver);
			Enterprise_Category_Report_Method_For_State(driver);
			Enterprise_Category_Report_Method_For_ZipCode(driver);
			Enterprise_Category_Report_Method_For_Store_BY_SplitByMenuItem(driver);
			Enterprise_Category_Report_Method_For_Group_SplitByMenuItem(driver);
			Enterprise_Category_Report_Method_For_City_SplitByMenuItem(driver);
			Enterprise_Category_Report_Method_For_State_SlitByMenuItem(driver);
			Enterprise_Category_Report_Method_For_ZipCode_SPlitByMenuItem(driver);
			Thread.sleep(1500);
		}
		...
		/*	//Check whether the Split by menu item is enabled or not
			...
			try
			{
				...
				if(!driver.findElement(By.xpath(excel.getData(3, 710, 1))).isDisplayed())
				{
					...
					Thread.sleep(5000);
					List<WebElement> totalRows = driver.findElements(By.xpath(excel.getData(3, 726, 1)));
					totalRows.size();
					...
					for(int i = 3; i <= 7; i++)
					{
						...
						System.out.println(driver.findElement(By.xpath(excel.getData(3, 727, 1))).getText());
						
						
						test.log(LogStatus.INFO, driver.findElement(By.xpath(excel.getData(3, 727, 1))).getText());
					}
			...
			test.log(LogStatus.INFO, "********************* End of Store Report (Split By Menu Item) *************************");wb.close();
wb.close();
		...
		/*	if(driver.findElement(By.xpath(excel.getData(3, 721, 1))).isSelected())
			...
			test.log(LogStatus.INFO, "********************* End of Group Report (Split By Menu Item) *************************");wb.close();
		wb.close();
		}
		...
		/*	if(driver.findElement(By.xpath(excel.getData(3, 721, 1))).isSelected())
			...
			*/
			...
			test.log(LogStatus.INFO, "********************* End of City Report (Split By Menu Item) *************************");wb.close();
		wb.close();
		}
		...
		/*	if(driver.findElement(By.xpath(excel.getData(3, 721, 1))).isSelected())
			...
			test.log(LogStatus.INFO, "********************* End of State Report (Split By Menu Item) *************************");wb.close();
		wb.close();
		}
		...
		/*	if(driver.findElement(By.xpath(excel.getData(3, 721, 1))).isSelected())
			...
			*/
			...
			test.log(LogStatus.INFO, "********************* End of Zip Code Report (Split By Menu Item) *************************");wb.close();
wb.close();
		}
