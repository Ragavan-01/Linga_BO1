...
public class AddEditDelete_Modifiers {
	...
	/*		//Click the Products/Items option
		...
		/*	WebDriverWait wait=new WebDriverWait(driver,60);
			...
			driver.findElement(By.xpath(excel.getData(3, 1632, 1))).click();
			...
			driver.findElement(By.xpath("//div[@class='form-group']/div[2]/a/i")).click();
			...
			driver.findElement(By.xpath(excel.getData(3, 169, 1))).click();
			//Enter the required option	//
			driver.findElement(By.xpath(excel.getData(3, 170, 1))).sendKeys("TOPPINGS");
			//Press the Enter Key
			driver.findElement(By.xpath(excel.getData(3, 170, 1))).sendKeys(Keys.ENTER);
			...
			driver.findElement(By.xpath(excel.getData(3, 184, 1))).click();
			
			Thread.sleep(2000);
			//CLear the prefix name field 
			driver.findElement(By.xpath(excel.getData(3, 185, 1))).clear();
			//Enter the required prefix name
			driver.findElement(By.xpath(excel.getData(3, 185, 1))).sendKeys("Add");
			
			Thread.sleep(2000);
			//Clear the price field
			driver.findElement(By.xpath(excel.getData(3, 186, 1))).clear();
			//Enter the Price
			driver.findElement(By.xpath(excel.getData(3, 186, 1))).sendKeys("125");
			...
			driver.findElement(By.xpath(excel.getData(3, 187, 1))).click();
			...
			driver.findElement(By.xpath(excel.getData(3, 188, 1))).click();
			
			Thread.sleep(3000);
			//Click the Serving Size Level Option
			driver.findElement(By.xpath(excel.getData(3, 189, 1))).click();
			//Enter the required Serving Size Level
			driver.findElement(By.xpath(excel.getData(3, 190, 1))).sendKeys("EACH");
			//Press the Enter Key
			driver.findElement(By.xpath(excel.getData(3, 190, 1))).sendKeys(Keys.ENTER);
			
			Thread.sleep(2000);
			//Clear the Price Option
			driver.findElement(By.xpath(excel.getData(3, 191, 1))).clear();
			//Enter the Price
			driver.findElement(By.xpath(excel.getData(3, 191, 1))).sendKeys("125");
		 	  
			Thread.sleep(2000);
			//Clear the Prefix Price Option
			driver.findElement(By.xpath(excel.getData(3, 192, 1))).clear();
			//Enter the Prefix Price
			driver.findElement(By.xpath(excel.getData(3, 192, 1))).sendKeys("125");
			...
			driver.findElement(By.xpath(excel.getData(3, 1641, 1))).click();
		...
		public void Modifiers_method_edit_Modifiers(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath(excel.getData(3, 165, 1))).click();
			//Enter the required Tax
			driver.findElement(By.xpath(excel.getData(3, 166, 1))).sendKeys("GST");
			//Press the Enter button
			driver.findElement(By.xpath(excel.getData(3, 166, 1))).sendKeys(Keys.ENTER);
		
			Thread.sleep(2000);
			//Click the Kitchen Printer Option 
			driver.findElement(By.xpath(excel.getData(3, 167, 1))).click();
			Thread.sleep(1000);
			//Enter the Kitchen Printer
			driver.findElement(By.xpath(excel.getData(3, 168, 1))).sendKeys("KitchenPrinter_1");
			//Press the Enter button
			driver.findElement(By.xpath(excel.getData(3, 168, 1))).sendKeys(Keys.ENTER);
		...
		public void Modifiers_method_add_Modifiers_Save_BasicDetails(WebDriver driver) throws Exception
		{
			...
			Thread.sleep(5000);
			//Click the Add Modifiers button
			driver.findElement(By.xpath(excel.getData(3, 162, 1))).click();
			...
			//Enter the required name
			driver.findElement(By.xpath(excel.getData(3, 34, 1))).sendKeys(Utility.getProperty("Modifier_Name")+1);
			...
			Thread.sleep(2000);
			//CLeare the maximum number of time 
			driver.findElement(By.name(excel.getData(3, 164, 1))).clear();
			//Enter the maximum number of time
			driver.findElement(By.name(excel.getData(3, 164, 1))).sendKeys("3");
			
			Thread.sleep(2000);
			//Click the Modify With Option
			driver.findElement(By.xpath(excel.getData(3, 164, 1))).click();
			//Enter the required option
			driver.findElement(By.xpath(excel.getData(3, 170, 1))).sendKeys("TOPPINGS");
			//Press the Enter Key
			driver.findElement(By.xpath(excel.getData(3, 170, 1))).sendKeys(Keys.ENTER);
