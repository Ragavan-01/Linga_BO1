...
public class AddEditDelete_Category {
	...
	public void flushTest() throws Exception
	{
		...
		public void Category_method_add_Category(WebDriver driver) throws Exception
		{
			...
			Thread.sleep(1000);
			//Click the Save button
			driver.findElement(By.xpath(excel.getData(0, 93, 1))).click();
			...
			driver.findElement(By.xpath(excel.getData(0, 102, 1))).sendKeys("BarNew");
			//Press the Enter Key
			...
			if(driver.findElement(By.xpath(excel.getData(0, 39, 1))).getText().equalsIgnoreCase("Category saved successfully"))
			{
...
/*			//Click the Select image from gallery option
			...
			driver.findElement(By.xpath(excel.getData(0, 115, 1))).click();
			Thread.sleep(2000);
			
			//Check it is AM or PM in the Start Time Option
			if(driver.findElement(By.xpath(excel.getData(0, 116, 1))).getText().equalsIgnoreCase("AM"))
			{
				Thread.sleep(2000);
				//Click the AM or PM option in the End Time
				driver.findElement(By.xpath(excel.getData(0, 117, 1))).click();
			}
			else
			{
				Thread.sleep(2000);
				//Click the AM or PM option in the Start Time
				driver.findElement(By.xpath(excel.getData(0, 116, 1))).click();
			}
			...
			if(driver.findElement(By.xpath(excel.getData(0, 39, 1))).getText().equalsIgnoreCase("Category updated successfully"))
			{
		...
		public void Category_method_edit_Category_DaysOfMonth(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath(excel.getData(0, 122, 1))).click();
		...
		public void Category_method_edit_Category_DateRange(WebDriver driver) throws Exception
		{
			...
			//Enable or Disable the Restriction Time option
			driver.findElement(By.xpath(excel.getData(0, 128, 1))).click();
		...
		public void Category_method_delete_Category(WebDriver driver) throws Exception
		{
			...
			if(driver.findElement(By.xpath(excel.getData(0, 39, 1))).getText().equalsIgnoreCase("Category activated successfully"))
			{
