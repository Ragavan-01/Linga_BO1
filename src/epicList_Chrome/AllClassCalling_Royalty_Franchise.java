...
public class AllClassCalling_Royalty_Franchise { 
	
	public WebDriver driver;
	ExtentReports rep = ExtentManager.getInstance();
	ExtentTest test = rep.startTest("BO-Royalty/Franchise");
	...
	public AllClassCalling_Royalty_Franchise() throws Throwable
	{
		Thread.sleep(2000);
