...
*/
		...
		//Click the Label Printer option
				...
				//Click the input field
				driver.findElement(By.xpath(excel.getData(5, 298, 1))).sendKeys("BarTab");
				//Press Enter button
...
/*		//Clear the Price option
	...
	//	startDay.selectByVisibleText("WEDNESDAY");
		...
		if(driver.findElement(By.xpath(excel.getData(5, 219, 1))).getText().equalsIgnoreCase("Menu item updated successfully"))
		{
	...
	public void Product_And_Item_method_deleteMenuItem(WebDriver driver) throws Exception
	{
		...
		if(driver.findElement(By.xpath(excel.getData(5, 219, 1))).getText().equalsIgnoreCase("Menu item inactivated successfully"))
		{
		...
		if(driver.findElement(By.xpath(excel.getData(5, 219, 1))).getText().equalsIgnoreCase("Menu item activated successfully"))
		{
	...
	public void Product_And_Item_method_addMenuItemByCopyMenuItem(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(5, 362, 1))).sendKeys(Keys.ARROW_DOWN);
		//Press the Enter button
		driver.findElement(By.xpath(excel.getData(5, 362, 1))).sendKeys(Keys.ENTER);		Thread.sleep(3000);
