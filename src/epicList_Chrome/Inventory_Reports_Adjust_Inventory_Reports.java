...
public class Inventory_Reports_Adjust_Inventory_Reports {
	...
	public void Inventory_Reports_Adjust_Inventory_Report(WebDriver driver) throws Exception
	{
		 File src = new File(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
			...
			driver.findElement(By.xpath(excel.getData(3, 1344, 1))).sendKeys(Utility.getReportProperty("ConsumptionLog_FromDate"));
			...
			driver.findElement(By.xpath(excel.getData(3, 1345, 1))).sendKeys(Utility.getReportProperty("ConsumptionLog_ToDate"));
