...
public class AddEditDelete_Serving_Size_Level {
	...
	ExtentTest test = rep.startTest("AddEditDelete Serving Size Level");
		...
		public void Serving_Size_Level_method_add_ServingSizeLevel(WebDriver driver) throws Exception
		{
			...
			if(driver.findElement(By.xpath(excel.getData(0, 39, 1))).getText().equalsIgnoreCase("Serving size level saved successfully"))
			{
		...
		public void Serving_Size_Level_method_edit_ServingSizeLevel(WebDriver driver) throws Exception
		{
			...
			if(driver.findElement(By.xpath(excel.getData(0, 39, 1))).getText().equalsIgnoreCase("Serving Size Level Updated Successfully"))
			{
		...
		public void Serving_Size_Level_method_delete_ServingSizeLevel(WebDriver driver) throws Exception
		{
			...
			if(driver.findElement(By.xpath(excel.getData(0, 39, 1))).getText().equalsIgnoreCase("Serving Size Level Inactivated Successfully"))
			{
			...
			if(driver.findElement(By.xpath(excel.getData(0, 39, 1))).getText().equalsIgnoreCase("Serving Size Level Activated Successfully"))
			{
