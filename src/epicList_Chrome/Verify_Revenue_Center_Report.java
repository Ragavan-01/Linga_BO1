...
/*				//Click the Reports option
		...
		public void Revenue_Center_Report_By_All_Options_Selected(WebDriver driver) throws Exception
		{
			    ...
			    driver.findElement(By.xpath(excel.getData(1, 1106, 1))).sendKeys(Utility.getReportProperty("Date_Range_From"));

			    //Clear the Date field
			    driver.findElement(By.xpath(excel.getData(1, 1107, 1))).clear();
			    //Enter the required date
			    driver.findElement(By.xpath(excel.getData(1, 1107, 1))).sendKeys(Utility.getReportProperty("Date_Range_To"));
		...
		public void Revenue_Center_Report_By_Required_Options_Selected(WebDriver driver) throws Exception
		{
			...
			ExcelDataConfig excel = new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
				...
				driver.findElement(By.xpath(excel.getData(1, 1125, 1))).sendKeys(Utility.getReportProperty("Sales_By_Revenue_Center"));
