...
/*		//Check Tax exempt page opened or not
	...
	public void Reasons_PaidIn_method_addPaidInReasons(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(ex.getData(4, 8, 1))).click();
		Thread.sleep(2000);
		
		//Check whether the new discount saved or not
		if(driver.findElement(By.xpath(ex.getData(4, 9, 1))).getText().equalsIgnoreCase("Saved successfully"))
		{
	...
	public void Reasons_PaidIn_method_editPaidInReasons(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(ex.getData(4, 10, 1))).clear();
		//Enter the required keyword
		driver.findElement(By.xpath(ex.getData(4, 10, 1))).sendKeys(Utility.getProperty("PaidInReason")+"1");
		Thread.sleep(4000);driver.findElement(By.xpath(ex.getData(4, 10, 1))).sendKeys(Keys.BACK_SPACE);
		Thread.sleep(4000);driver.findElement(By.xpath(ex.getData(4, 10, 1))).sendKeys(Keys.ENTER);
		Thread.sleep(8000);
		//Click the Edit icon
		...
		driver.findElement(By.name(ex.getData(4, 6, 3))).clear();
		//Enter the Reasons
		driver.findElement(By.name(ex.getData(4, 6, 3))).sendKeys(Utility.getProperty("PaidInReason")+"1");
		...
		if(driver.findElement(By.xpath(ex.getData(4, 9, 1))).getText().equalsIgnoreCase("Updated successfully"))
		{
	...
	public void Reasons_PaidIn_method_deletePaidInReasons(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(ex.getData(4, 10, 1))).clear();
		//Enter the required keyword
		driver.findElement(By.xpath(ex.getData(4, 10, 1))).sendKeys(Utility.getProperty("PaidInReason")+"11");
		Thread.sleep(4000);driver.findElement(By.xpath(ex.getData(4, 10, 1))).sendKeys(Keys.BACK_SPACE);
		Thread.sleep(4000);driver.findElement(By.xpath(ex.getData(4, 10, 1))).sendKeys(Keys.ENTER);
		Thread.sleep(8000);
		...
		if(driver.findElement(By.xpath(ex.getData(4, 9, 1))).getText().equalsIgnoreCase("Inactivated successfully"))
		{
		...
		driver.findElement(By.xpath(ex.getData(4, 15, 1))).click();
		Thread.sleep(3000);
		...
		if(driver.findElement(By.xpath(ex.getData(4, 9, 1))).getText().equalsIgnoreCase("Activated successfully"))
		{
	...
	public void Reasons_PaidIn_method_closeButton(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(ex.getData(4, 16, 1))).click();
		Thread.sleep(3000);
