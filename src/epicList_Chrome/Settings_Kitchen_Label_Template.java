...
/*		//Click the Settings option
		...
		driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id")+"newKitchenLabelTemplate");
		Thread.sleep(5000);
	...
	public void Kitchen_Label_Template_method_update_Kitchen_Label_Template(WebDriver driver) throws Exception
	{
		...
		if(driver.findElement(By.cssSelector(excel.getData(3, 39, 1))).getText().equalsIgnoreCase("Label template saved successfully"))
		{
