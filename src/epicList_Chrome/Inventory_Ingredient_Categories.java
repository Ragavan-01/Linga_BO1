...
//			SendMail.snedMailWithAttachment();
		...
		public void Inventory_Ingredient_Categories_openpage(WebDriver driver) throws Exception
		{
			...
			if(driver.findElement(By.xpath(excel.getData(3, 1170, 1))).getText().equalsIgnoreCase("Category"))
			{
		...
		public void Inventory_Ingredient_Categories_refresh_page(WebDriver driver) throws Exception
		{
			...
			if(driver.findElement(By.xpath(excel.getData(3, 1172, 1))).getText().equalsIgnoreCase("Category"))
			{
		...
		public void Inventory_Ingredient_Categories_add_Invetory_Category(WebDriver driver) throws Exception
		{
			...
			if(driver.findElement(By.xpath(excel.getData(3, 1173, 1))).getText().equalsIgnoreCase("New Category"))
			{
...
//			Thread.sleep(3000);
			//Enter the Name
			driver.findElement(By.name(excel.getData(3, 1175, 3))).sendKeys(Utility.getProperty("Inventory_Ingredient_Category"));
			Thread.sleep(2000);
			...
			driver.findElement(By.name(excel.getData(3, 1174, 3))).sendKeys("Inventory Ingredient Category");
			...
			if(wait.until(ExpectedConditions.visibilityOf(ingCat)).getText().equalsIgnoreCase("category saved successfully!."))
			{
		...
		public void Inventory_Ingredient_Categories_edit_Invetory_Category(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath(excel.getData(3, 40, 1))).sendKeys(Utility.getProperty("Inventory_Ingredient_Category"));
			Thread.sleep(4000);
			//Click the Edit icon
			...
			driver.findElement(By.name(excel.getData(3, 1175, 3))).clear();
			//Enter the Name
			driver.findElement(By.name(excel.getData(3, 1175, 3))).sendKeys(Utility.getProperty("Inventory_Ingredient_Category")+"1");
			...
			if(wait.until(ExpectedConditions.visibilityOf(ingCat)).getText().equalsIgnoreCase("Category updated successfully!."))
			{
		...
		public void Inventory_Ingredient_Categories_delete_Invetory_Category(WebDriver driver) throws Exception
		{
			...
			Thread.sleep(4000);
			//Enter the required keyword
			driver.findElement(By.xpath(excel.getData(3, 40, 1))).sendKeys(Utility.getProperty("Inventory_Ingredient_Category")+"1");
			...
			if(wait.until(ExpectedConditions.visibilityOf(ingCat)).getText().equalsIgnoreCase("Category InActivated Successfully!"))
			{
				test.log(LogStatus.PASS, "New Ingredient Category deleted Sucessfully");
			}
			else
			{ 
				test.log(LogStatus.FAIL, "New Ingredient Category deleted Failed");wb.close();
			}
		}
		...
		{ 
			...
			if(driver.findElement(By.xpath(excel.getData(3, 39, 1))).getText().equalsIgnoreCase("Category activated Successfully!."))
			{
			...
			//Check whether the new form loaded or not
			if(driver.findElement(By.xpath(excel.getData(3, 1178, 1))).getText().equalsIgnoreCase("New Category"))
			{
				test.log(LogStatus.PASS, "New Category form loaded Successfully");
			}
			else
			...
			//Enter the Name
			driver.findElement(By.name(excel.getData(3, 254, 3))).sendKeys(Utility.getProperty("Inventory_Ingredient_Category"));
			Thread.sleep(2000);
