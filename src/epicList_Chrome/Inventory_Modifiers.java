...
public class Inventory_Modifiers {
	...
	*/
					...
					if(driver.findElement(By.xpath(excel.getData(3, 39, 1))).getText().equalsIgnoreCase("Inventory item saved successfully!."))
					{
				...
				*/
				...
				//driver.findElement(By.xpath("//input[@class='form-control ng-pristine ng-valid ng-touched']")).sendKeys("2");
					...
					Thread.sleep(2000);			
						...
						//Enter the name		
						driver.findElement(By.id(excel.getData(2, 100, 2))).sendKeys(Utility.getProperty("Inventory_SubRecipe_Primary_Storage_Name_ForModifier"));				
						Thread.sleep(1000);		
					...
					driver.findElement(By.xpath(excel.getData(2, 185, 1))).click();
				 	...
				 	Thread.sleep(4000);
				  	//Check whether the new Inventory Items saved or not
					if(driver.findElement(By.xpath(excel.getData(3, 39, 1))).getText().equalsIgnoreCase("Modifier updated sucessfully!."))
					{
