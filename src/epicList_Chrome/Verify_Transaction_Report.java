...
/*				WebElement html = driver.findElement(By.tagName("html"));
			...
			/*					String netSales = driver.findElement(By.xpath("//table[@class='table table-bordered ng-table-responsive']/tbody/tr[1]/td[3]/span")).getText();
						...
						Thread.sleep(3000);
						//Get the Total Value
						String tot = driver.findElement(By.xpath(excel.getData(1, 830, 1))).getText().replaceAll("[a-zA-Z $ ₹ , :]", "");
						double totaAmt = Double.parseDouble(tot);
							
						//Get the CC Service Charge Value
						String ccs =  driver.findElement(By.xpath(excel.getData(1, 831, 1))).getText().replaceAll("[a-zA-Z $ ₹ , :]", "");
						double ccsAmt = Double.parseDouble(ccs);
						
						//Get the Tip Value
						String tips =  driver.findElement(By.xpath(excel.getData(1, 832, 1))).getText().replaceAll("[a-zA-Z $ ₹ , :]", "");
