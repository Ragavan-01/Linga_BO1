		...
		public void calling() throws Exception
		{
			...
			public void Sale_Recap_Sale_method_Verify_Report(WebDriver driver) throws Exception
			{
				...
				if(driver.getPageSource().contains("CHECK STATS"))
				{
					...
					if(driver.findElement(By.xpath(excel.getData(1, 763, 1))).getText().equals(Utility.getReportProperty("Check_Count")))
					{
						test.log(LogStatus.PASS, "Actual and Expected check counts are same");
						
			        	//Get the Total value of Check Count
			        	String actualText1 = driver.findElement(By.xpath(excel.getData(1, 763, 1))).getText();
					...
					else if(expect1 == unknownValue)
					{
			        	...
			        	//Get the Total value of Check Count
			        	String actualText = driver.findElement(By.xpath(excel.getData(1, 763, 1))).getText();
