...
public class Settings_Delivery {
			...
			float unknownValue = 00;
				...
				public void Delivery_Settings_Method_open(WebDriver driver) throws Exception {
					...
					//Enter the URL
					driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id")+"newDeliveryZone");
				...
				public void Delivery_Settings_Method_edit(WebDriver driver) throws Exception {
					...
					driver.findElement(By.tagName(excel.getData(5, 174, 5))).sendKeys(Keys.HOME);
					Thread.sleep(1000);
					if(driver.findElement(By.cssSelector(excel.getData(5, 49, 4))).getText().equalsIgnoreCase("Delivery Zone Settings updated Successfully"))
					{
					...
					if(driver.findElement(By.cssSelector(excel.getData(5, 49, 4))).getText().equalsIgnoreCase("Delivery Zones Synced Successfully"))
					{
