...
import org.testng.ITestResult;
	...
	public class Settings_Payment { 
			...
			float unknownValue = 00;
				...
				public void Settings_Payment_Method_open(WebDriver driver2) throws Exception {
					// TODO Auto-generated method stub
					ExcelDataConfig excel = new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
					//Enter the URL
					driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id")+"newStorePayments");
			...
			public void Payment_Settings_Method_edit(WebDriver driver) throws Exception
				...
				if(driver.findElement(By.xpath("//label[contains(.,'Service Charge')]/../../div/div/input")).isSelected())
				{
					...
					if(driver.findElement(By.xpath(excel.getData(5, 449, 1))).isSelected())
					{
						...
						driver.findElement(By.xpath(excel.getData(5, 453, 1))).sendKeys("1500");
				...
				//Payment type
			       ...
			       //Prority
							...
							//Payment type
						       ...
						       //Prority
								...
								//Payment type
									...
									//Payment type input field
									driver.findElement(By.xpath(excel.getData(5, 457, 1))).click();
									driver.findElement(By.xpath(excel.getData(5, 457, 1))).sendKeys("Dejavoo");
									//payment name
								    driver.findElement(By.xpath(excel.getData(5, 457, 1))).sendKeys(Keys.ENTER);
	    			...
	    			driver.findElement(By.xpath(excel.getData(5, 481, 1))).sendKeys("10");
	    			//update the existing one
