...
public class AllClassCalling_Central_Inventory 
{ 
	
	public WebDriver driver;
	ExtentReports rep = ExtentManager.getInstance();
	ExtentTest test = rep.startTest("BO-Central Inventory");
	...
	public AllClassCalling_Central_Inventory() throws Throwable
	{
		Thread.sleep(2000);
