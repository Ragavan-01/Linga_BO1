...
/*		//Click the My Stores option
	...
	public void Enterprise_Report_Stores(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(3, 1525, 1))).sendKeys(Utility.getReportProperty("Store"));
		//Press the Enter button
		...
		driver.findElement(By.xpath(excel.getData(3, 1528, 1))).sendKeys(Utility.getReportProperty("Date_Range_From"));
		
		//Clear the date field
		driver.findElement(By.xpath(excel.getData(3, 1529, 1))).clear();
		//Enter the required date
		driver.findElement(By.xpath(excel.getData(3, 1529, 1))).sendKeys(Utility.getReportProperty("Date_Range_To"));
		...
		try
		{
			...
			if(driver.findElement(By.xpath(excel.getData(3, 1530, 1))).getText().equalsIgnoreCase(Utility.getReportProperty("Store")))
			{
	...
	public void Enterprise_Report_Group(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(3, 1524, 1))).click();
		//Enter the required option
		driver.findElement(By.xpath(excel.getData(3, 1525, 1))).sendKeys(Utility.getReportProperty("Group"));
		//Press the Enter button
		driver.findElement(By.xpath(excel.getData(3, 1525, 1))).sendKeys(Keys.ENTER);
	...
	public void Enterprise_Report_City(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(3, 1524, 1))).click();
		//Enter the required option
		driver.findElement(By.xpath(excel.getData(3, 1525, 1))).sendKeys(Utility.getReportProperty("City"));
		//Press the Enter button
		driver.findElement(By.xpath(excel.getData(3, 1525, 1))).sendKeys(Keys.ENTER);
	...
	public void Enterprise_Report_State(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(3, 1524, 1))).click();
		//Enter the required option
		driver.findElement(By.xpath(excel.getData(3, 1525, 1))).sendKeys(Utility.getReportProperty("State"));
		//Press the Enter button
		driver.findElement(By.xpath(excel.getData(3, 1525, 1))).sendKeys(Keys.ENTER);
	...
	public void Enterprise_Report_ZipCode(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(3, 1524, 1))).click();
		//Enter the required option
		driver.findElement(By.xpath(excel.getData(3, 1525, 1))).sendKeys(Utility.getReportProperty("Zipcode"));
		//Press the Enter button
		driver.findElement(By.xpath(excel.getData(3, 1525, 1))).sendKeys(Keys.ENTER);
