...
public class AddEditDelete_ProductItems_RetailItem_NEW {
	...
	*/		
		//	Thread.sleep(5000);
			...
			if(driver.findElement(By.xpath(excel.getData(4, 40, 1))).getText().equalsIgnoreCase("Menu Items"))
			{
		...
		public void Retail_Item_Pagination(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath(excel.getData(4, 10, 1))).clear();
			Thread.sleep(1000);
			
			//Click the Pagination option as 10
			driver.findElement(By.xpath(excel.getData(4, 41, 1))).click();
			test.log(LogStatus.INFO, "Now we click the Pagination option as 10");
			//Create the web element for menu item Table
			List<WebElement> results = driver.findElements(By.xpath(excel.getData(4, 42, 1)));
			...
			driver.findElement(By.xpath(excel.getData(4, 43, 1))).click();
			test.log(LogStatus.INFO, "Now we click the Pagination option as 15");
			//Create the web element for menu item Table
			List<WebElement> results1 = driver.findElements(By.xpath(excel.getData(4, 42, 1)));
			...
			driver.findElement(By.xpath(excel.getData(4, 44, 1))).click();
			test.log(LogStatus.INFO, "Now we click the Pagination option as 20");
			//Create the web element for menu item Table
			List<WebElement> results2 = driver.findElements(By.xpath(excel.getData(4, 42, 1)));
			...
			driver.findElement(By.xpath(excel.getData(4, 45, 1))).click();
			test.log(LogStatus.INFO, "Now we click the Pagination option as 5");
			//Create the web element for menu item Table
			List<WebElement> results3 = driver.findElements(By.xpath(excel.getData(4, 42, 1)));
		...
		public void Retail_Item_add_Retail_Item(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath(excel.getData(4, 46, 1))).click();
			Thread.sleep(3000);
			//Check whether the new form loaded or not
			if(driver.findElement(By.xpath(excel.getData(4, 47, 1))).getText().equalsIgnoreCase("NEW RETAIL ITEM"))
			{
			...
			driver.findElement(By.xpath(excel.getData(4, 48, 1))).clear();
			//Enter the Name
			driver.findElement(By.xpath(excel.getData(4, 48, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_Name"));
			Thread.sleep(2000);
			//Clear the Secondary Name field
			driver.findElement(By.xpath(excel.getData(4, 49, 1))).clear();
			//Enter the Secondary Name
			driver.findElement(By.xpath(excel.getData(4, 49, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_SecName"));
			Thread.sleep(1000);
			
			//Select the required Level
			Select level = new Select(driver.findElement(By.xpath(excel.getData(4, 50, 1))));
			level.selectByVisibleText("Category");
			
			//Click the Category option
			driver.findElement(By.xpath(excel.getData(4, 51, 1))).click();
			//Enter the required Category
			driver.findElement(By.xpath(excel.getData(4, 52, 1))).sendKeys(Keys.ARROW_DOWN);
			//Press the Enter button
			driver.findElement(By.xpath(excel.getData(4, 52, 1))).sendKeys(Keys.ENTER);
			
			Thread.sleep(3000);
			//Clear the SKU code
			driver.findElement(By.xpath(excel.getData(4, 53, 1))).clear();
			//Enter the SKU code
			driver.findElement(By.xpath(excel.getData(4, 53, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_SKUcode"));
			
			//Click the Add SKU button
			driver.findElement(By.xpath(excel.getData(4, 54, 1))).click();
			//Clear the SKU code of newly added one
			driver.findElement(By.xpath(excel.getData(4, 55, 1))).clear();
			//Enter the SKU code of newly added one
			driver.findElement(By.xpath(excel.getData(4, 55, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_SKUcode")+"new");		
			...
			driver.findElement(By.xpath(excel.getData(4, 58, 1))).click();
			//Enter the required Serving size Level
			driver.findElement(By.xpath(excel.getData(4, 59, 1))).sendKeys(Keys.ARROW_DOWN);
			//Press the Enter Key
			driver.findElement(By.xpath(excel.getData(4, 59, 1))).sendKeys(Keys.ENTER);
					
			//Clear the Price option
			driver.findElement(By.name(excel.getData(4, 60, 3))).clear();
			//Enter the required price
			driver.findElement(By.name(excel.getData(4, 60, 3))).sendKeys("125");
			...
			driver.findElement(By.xpath(excel.getData(4, 62, 1))).click();
			
			Thread.sleep(5000);
			//Check weather new tax form loaded or not
			if(driver.findElement(By.xpath(excel.getData(4, 63, 1))).getText().equalsIgnoreCase("New Tax"))
			{
			...
			driver.findElement(By.xpath(excel.getData(4, 64, 1))).clear();
			//Enter the required new tax Name field
			driver.findElement(By.xpath(excel.getData(4, 64, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_TaxName"));
			...
			driver.findElement(By.name(excel.getData(4, 65, 3))).clear();
			//Enter the required percentage
			driver.findElement(By.name(excel.getData(4, 65, 3))).sendKeys("5000");
			
			Thread.sleep(1000);
			//click the Save button
			driver.findElement(By.cssSelector(excel.getData(4, 66, 4))).click();		
			Thread.sleep(10000);
	
			//Enable or disable the Do not show Button on POS
			driver.findElement(By.xpath(excel.getData(4, 67, 1))).click();
			...
			driver.findElement(By.xpath(excel.getData(4, 71, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_User_Img"));
			
			Thread.sleep(3000);
			//Click the Applicable Time Period option
			driver.findElement(By.xpath(excel.getData(4, 72, 1))).click();
			//Enter the required Time Period
			driver.findElement(By.xpath(excel.getData(4, 73, 1))).sendKeys("Always");
			//Press the Enter button
			driver.findElement(By.xpath(excel.getData(4, 73, 1))).sendKeys(Keys.ENTER);
			...
			Thread.sleep(10000);
			//select the required level
			Select leve = new Select(driver.findElement(By.xpath(excel.getData(4, 50, 1))));
			leve.selectByVisibleText("Category");
			Thread.sleep(10000);
			//Click the Add new Inventory Category Button 
		    driver.findElement(By.xpath(excel.getData(4, 75, 1))).click();
			Thread.sleep(5000);
			//Check weather new Inventory Category form loaded or not
			if(driver.findElement(By.xpath(excel.getData(4, 76, 1))).getText().equalsIgnoreCase("New Category"))
			{
			...
			//Clear the name field
			driver.findElement(By.xpath(excel.getData(4, 77, 1))).clear();
			//Enter the Category name
			driver.findElement(By.xpath(excel.getData(4, 77, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_Inventory_CategoryName"));
			
			//CLear the description field
			driver.findElement(By.xpath(excel.getData(4, 78, 1))).clear();
			//Enter the required description
			driver.findElement(By.xpath(excel.getData(4, 78, 1))).sendKeys("NewCategory Description");
			...
			driver.findElement(By.xpath(excel.getData(4, 79, 1))).click();
										 
			Thread.sleep(5000);
			//Check weather new Primary Storage form loaded or not
			if(driver.findElement(By.xpath(excel.getData(4, 80, 1))).getText().equalsIgnoreCase("New Storage Location"))
			{
			...
			driver.findElement(By.xpath(excel.getData(4, 77, 1))).clear();
			//Enter the name
			driver.findElement(By.xpath(excel.getData(4, 77, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_Storage_Name"));
			
			//CLear the description field
			driver.findElement(By.xpath(excel.getData(4, 78, 1))).clear();
			//Enter the required description
			driver.findElement(By.xpath(excel.getData(4, 78, 1))).sendKeys("New Storage Description");
			...
			driver.findElement(By.xpath(excel.getData(4, 81, 1))).click();
			Thread.sleep(2000);
			//Enter the required storage location
			driver.findElement(By.xpath(excel.getData(4, 82, 1))).sendKeys(Keys.ARROW_DOWN);
			Thread.sleep(2000);
			//Press the Enter key
			driver.findElement(By.xpath(excel.getData(4, 82, 1))).sendKeys(Keys.ENTER);
			
			if(driver.findElement(By.xpath(excel.getData(4, 83, 1))).isEnabled())
			{
				//Enable the Calculate COGS on Cost Prise
				driver.findElement(By.xpath(excel.getData(4, 84, 1))).click();
			}
			
			//Click the Add new Vendor Button
			driver.findElement(By.xpath(excel.getData(4, 85, 1))).click();
			
			Thread.sleep(5000);
			//Check weather new vendor form loaded or not
			if(driver.findElement(By.xpath(excel.getData(4, 86, 1))).getText().equalsIgnoreCase("New Vendor"))
			{
			...
			driver.findElement(By.xpath(excel.getData(4, 77, 1))).clear();
			//Enter the Category name
			driver.findElement(By.xpath(excel.getData(4, 77, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_Vendor_Name"));
			...
			driver.findElement(By.name(excel.getData(4, 87, 3))).clear(); 
			//Enter the Brand Name
			driver.findElement(By.name(excel.getData(4, 87, 3))).sendKeys("Retail_Brand");
			
			
			//Click the Selling Unit Option
			driver.findElement(By.xpath(excel.getData(4, 88, 1))).click();
			//Enter the required Selling Unit Option
			driver.findElement(By.xpath(excel.getData(4, 89, 1))).sendKeys(Keys.ARROW_DOWN);
			//Press the Enter Key
			driver.findElement(By.xpath(excel.getData(4, 89, 1))).sendKeys(Keys.ENTER);
			...
			driver.findElement(By.xpath(excel.getData(4, 92, 1))).click();
		...
		public void Retail_Item_Edit_Retail_Item(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath(excel.getData(4, 10, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_Name")+"1");
			Thread.sleep(3000);driver.findElement(By.xpath(excel.getData(4, 10, 1))).sendKeys(Keys.BACK_SPACE);
			...
			driver.findElement(By.xpath(excel.getData(4, 48, 1))).clear();
			//Enter the Name			 
			driver.findElement(By.xpath(excel.getData(4, 48, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_Name")+"1");
			...
			driver.findElement(By.xpath(excel.getData(4, 94, 1))).click();
			//Enter the required Sub category
			driver.findElement(By.xpath(excel.getData(4, 95, 1))).sendKeys(Keys.ARROW_DOWN);
			//Press the Enter Key
			driver.findElement(By.xpath(excel.getData(4, 95, 1))).sendKeys(Keys.ENTER);
			//System.out.println("Test 1");
			Thread.sleep(8000);
			//Click the Serving Size option
			driver.findElement(By.xpath(excel.getData(4, 96, 1))).click();
			//Enter the required serving size level
			driver.findElement(By.xpath(excel.getData(4, 97, 1))).sendKeys(Keys.ARROW_DOWN);
			//Press Enter Key
			driver.findElement(By.xpath(excel.getData(4, 97, 1))).sendKeys(Keys.ENTER);
			
			//Clear the price option
			driver.findElement(By.name(excel.getData(4, 60, 3))).clear();
			//Enter the price
			driver.findElement(By.name(excel.getData(4, 60, 3))).sendKeys("255");
			...
			driver.findElement(By.xpath(excel.getData(4, 98, 1))).click();
			
			Thread.sleep(3000);
			//Click the taxes option
			driver.findElement(By.xpath(excel.getData(4, 99, 1))).click();
			//Enter the required tax
			driver.findElement(By.xpath(excel.getData(4, 100, 1))).sendKeys(Keys.ARROW_DOWN);
			//Press the Enter Key
			driver.findElement(By.xpath(excel.getData(4, 100, 1))).sendKeys(Keys.ENTER);
			
			if(driver.findElement(By.xpath(excel.getData(4, 101, 1))).isEnabled())
			{
			Thread.sleep(3000);
			//Enable or disable the EBT menu item
			driver.findElement(By.xpath(excel.getData(4, 101, 1))).click();
			}
			...
			driver.findElement(By.xpath(excel.getData(4, 104, 1))).click();
			//Enter the required time option from the given item list
			driver.findElement(By.xpath(excel.getData(4, 105, 1))).sendKeys("Days of Week");
			//Press the Enter Key in the Applicable time period option field
			driver.findElement(By.xpath(excel.getData(4, 105, 1))).sendKeys(Keys.ENTER);
			
			//Click the Days of Week Option
			driver.findElement(By.xpath(excel.getData(4, 106, 1))).click();
			//Enter the required DAY for Searching
			driver.findElement(By.xpath(excel.getData(4, 107, 1))).sendKeys("WEDNESDAY");
			//Press the Enter key after enter the keyword
			driver.findElement(By.xpath(excel.getData(4, 107, 1))).sendKeys(Keys.ENTER);
	
			//Enable or Disable the Restriction Time option
			driver.findElement(By.xpath(excel.getData(4, 108, 1))).click();
			
			//Check it is AM or PM in the Start Time Option
			if(driver.findElement(By.xpath(excel.getData(4, 109, 1))).getText().equalsIgnoreCase("AM"))
			{
				Thread.sleep(2000);
			...
			if(driver.findElement(By.xpath(excel.getData(4, 112, 1))).getText().equalsIgnoreCase("Retail item updated and published successfully"))
			{
			...
			driver.findElement(By.xpath(excel.getData(4, 10, 1))).clear();
			//Enter the required keyword
			driver.findElement(By.xpath(excel.getData(4, 10, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_Name"));
			Thread.sleep(3000);
		...
		public void Retail_Item_Delete_Retail_Item(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath(excel.getData(4, 10, 1))).clear();
			//Enter the required keyword
			driver.findElement(By.xpath(excel.getData(4, 10, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_Name")+"11");
			Thread.sleep(3000);driver.findElement(By.xpath(excel.getData(4, 10, 1))).sendKeys(Keys.BACK_SPACE);
			...
			if(driver.findElement(By.xpath(excel.getData(4, 112, 1))).getText().equalsIgnoreCase("Menu item inactivated successfully"))
			{
			...
			driver.findElement(By.xpath(excel.getData(4, 32, 1))).click();
			Thread.sleep(3000);
			...
			if(driver.findElement(By.xpath(excel.getData(4, 112, 1))).getText().equalsIgnoreCase("Menu item activated successfully"))
			{
		...
		public void Retail_Item_Add_RetailItem_By_Copy_RetailItem(WebDriver driver) throws Exception
		{
			...
			ExcelDataConfig excel = new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
			//Click on the Add Retail Item option
			driver.findElement(By.xpath(excel.getData(4, 114, 1))).click();
			Thread.sleep(3000);
			//Check whether the new form loaded or not
			if(driver.findElement(By.xpath(excel.getData(4, 47, 1))).getText().equalsIgnoreCase("NEW RETAIL ITEM"))
			{
			...
			driver.findElement(By.xpath(excel.getData(4, 115, 1))).click();
			//Enter the REquired retail Item
			driver.findElement(By.xpath(excel.getData(4, 116, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_Name")+"1");
			//Press the Enter Key
			driver.findElement(By.xpath(excel.getData(4, 116, 1))).sendKeys(Keys.ENTER);
			Thread.sleep(2000);
			
			//Press the Copy button
			driver.findElement(By.xpath(excel.getData(4, 117, 1))).click();
			
			Thread.sleep(2000);
			//Click the Clear Option  
			driver.findElement(By.xpath(excel.getData(4, 118, 1))).click();
			...
			driver.findElement(By.xpath(excel.getData(4, 48, 1))).clear();
			//Enter the Name
			driver.findElement(By.xpath(excel.getData(4, 48, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_Name")+"10");
			...
			driver.findElement(By.xpath(excel.getData(4, 53, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_SKUcode")+"2");
			...
			driver.findElement(By.name(excel.getData(4, 60, 3))).clear();
			//Enter the required price
			driver.findElement(By.name(excel.getData(4, 60, 3))).sendKeys("215");
			...
			driver.findElement(By.xpath(excel.getData(4, 104, 1))).click();
			//Enter the required time option from the given item list
			driver.findElement(By.xpath(excel.getData(4, 105, 1))).sendKeys("Days of Month");
			//Press the Enter Key in the Applicable time period option field
			driver.findElement(By.xpath(excel.getData(4, 105, 1))).sendKeys(Keys.ENTER);
			
			//Click the Required Date form the Calendar
			driver.findElement(By.xpath(excel.getData(4, 119, 1))).click();
			Thread.sleep(2000);
			
			//Enable or Disable the Restriction Months option
			driver.findElement(By.xpath(excel.getData(4, 120, 1))).click();
			
			Thread.sleep(2000);
			//Click the months field
			driver.findElement(By.xpath(excel.getData(4, 121, 1))).click();
			//Enter the Required month
			driver.findElement(By.xpath(excel.getData(4, 122, 1))).sendKeys("MAY");
			//Press the Enter Key
			driver.findElement(By.xpath(excel.getData(4, 122, 1))).sendKeys(Keys.ENTER);
			...
			//Click the Save button
			driver.findElement(By.xpath(excel.getData(4, 29, 1))).click();
			Thread.sleep(3000);
			
			//Check whether the new Retail saved or not
			if(driver.findElement(By.xpath(excel.getData(4, 112, 1))).getText().equalsIgnoreCase("Retail item saved successfully"))
			{
		...
		public void Retail_Item_cancelRetailItemByCopyRetailItem_Inventory_Details(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath(excel.getData(4, 48, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_Name")+"10");
			  ...
			  //Enter the SKU COde 
			  driver.findElement(By.xpath(excel.getData(4, 53, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_SKUcode")+"31");
			...
			//Click the Cancel button
			driver.findElement(By.xpath(excel.getData(4, 123, 1))).click();
			Thread.sleep(3000);
			
			//Check whether the new retail item cancelled or not
			if(driver.findElement(By.xpath(excel.getData(4, 124, 1))).getText().equalsIgnoreCase("Menu items"))
			{
		...
		public void Retail_Item_cancelRetailItemByCopyRetailItem_Childs(WebDriver driver) throws Exception
		{
			...
			Thread.sleep(2000);
			//Clear the sku code
			driver.findElement(By.xpath(excel.getData(4, 53, 1))).clear();Thread.sleep(2000);
			Thread.sleep(2000);
			//Enter the SKU COde
			driver.findElement(By.xpath(excel.getData(4, 53, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_SKUcode")+"3e");
		...
		public void Retail_Item_saveAndContinueRetailItemByCopyRetailItem(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath(excel.getData(4, 48, 1))).clear();
			//Enter the Name
			driver.findElement(By.xpath(excel.getData(4, 48, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_Name")+"11");
			...
			Thread.sleep(2000);
			//Enter the SKU COde
			driver.findElement(By.xpath(excel.getData(4, 53, 1))).sendKeys(Utility.getProperty("Product_Retail_Items_SKUcode")+"3");
			Thread.sleep(2000);
			
			//Click the Applicable Time Period field
			driver.findElement(By.xpath(excel.getData(4, 104, 1))).click();
			//Enter the required time option from the given item list
			driver.findElement(By.xpath(excel.getData(4, 105, 1))).sendKeys("Always");
			//Press the Enter Key in the Applicable time period option field
			driver.findElement(By.xpath(excel.getData(4, 105, 1))).sendKeys(Keys.ENTER);
