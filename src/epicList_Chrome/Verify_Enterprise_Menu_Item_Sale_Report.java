...
public class Verify_Enterprise_Menu_Item_Sale_Report {
	...
	float unknownValue = 00;
		...
		public void Enterprise_Menu_Item_Report_Method_For_Stores(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath("//select[@name='stores']/../div/ul/li/input")).sendKeys(Utility.getReportProperty("Store"));
			//Press the Enter button
			...
			driver.findElement(By.xpath("//input[@ng-model='query.fromDate']")).sendKeys(Utility.getReportProperty("Date_Range_From"));
			
			Thread.sleep(1500);
			//Clear the date field
			driver.findElement(By.xpath("//input[@ng-model='query.toDate']")).clear();
			//Enter the required date
			driver.findElement(By.xpath("//input[@ng-model='query.toDate']")).sendKeys(Utility.getReportProperty("Date_Range_To"));
		...
		public void Enterprise_Menu_Item_Report_Method_For_Group(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath("//select[@name='stores']/../div/ul")).click();
			//Enter the required option
			driver.findElement(By.xpath("//select[@name='stores']/../div/ul/li/input")).sendKeys((Utility.getReportProperty("Group")));
			//Press the Enter button
			driver.findElement(By.xpath("//select[@name='stores']/../div/ul/li/input")).sendKeys(Keys.ENTER);
		...
		public void Enterprise_Menu_Item_Report_Method_For_City(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath("//select[@name='stores']/../div/ul")).click();
			//Enter the required option
			driver.findElement(By.xpath("//select[@name='stores']/../div/ul/li/input")).sendKeys(Utility.getReportProperty("City"));
			//Press the Enter button
			driver.findElement(By.xpath("//select[@name='stores']/../div/ul/li/input")).sendKeys(Keys.ENTER);
		...
		public void Enterprise_Menu_Item_Report_Method_For_State(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath("//select[@name='stores']/../div/ul")).click();
			//Enter the required option
			driver.findElement(By.xpath("//select[@name='stores']/../div/ul/li/input")).sendKeys(Utility.getReportProperty("State"));
			//Press the Enter button
			driver.findElement(By.xpath("//select[@name='stores']/../div/ul/li/input")).sendKeys(Keys.ENTER);
		...
		public void Enterprise_Menu_Item_Report_Method_For_ZipCode(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath("//select[@name='stores']/../div/ul")).click();
			//Enter the required option
			driver.findElement(By.xpath("//select[@name='stores']/../div/ul/li/input")).sendKeys(Utility.getReportProperty("Zipcode"));
			//Press the Enter button
			driver.findElement(By.xpath("//select[@name='stores']/../div/ul/li/input")).sendKeys(Keys.ENTER);
