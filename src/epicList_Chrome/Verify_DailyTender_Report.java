	...
	public WebDriver driver;
		...
		public void DailyTender_Report_Method_verify(WebDriver driver) throws Exception
		{
		   ...
		   //Enter the specific date
		    driver.findElement(By.xpath(excel.getData(3, 1062, 1))).sendKeys(Utility.getReportProperty("Date_Range_From"));
		   ...
		   //Enter the specific date
		    driver.findElement(By.xpath(excel.getData(3, 1063, 1))).sendKeys(Utility.getReportProperty("Date_Range_To"));
