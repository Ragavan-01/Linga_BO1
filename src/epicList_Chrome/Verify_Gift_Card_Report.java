	...
	float unknownValue = 00;
		...
		public void calling() throws Exception
		{
			...
			public void Gift_Card_Report_Verify(WebDriver driver) throws Exception
			{
				...
				//Enter the date
				driver.findElement(By.xpath(excel.getData(1, 957, 1))).sendKeys(Utility.getReportProperty("Date_Range_From"));
	
				Thread.sleep(2000);
				//Clear the date field
				driver.findElement(By.xpath(excel.getData(1, 958, 1))).clear();
				//Enter the date
				driver.findElement(By.xpath(excel.getData(1, 958, 1))).sendKeys(Utility.getReportProperty("Date_Range_To"));
