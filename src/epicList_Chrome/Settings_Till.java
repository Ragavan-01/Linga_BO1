...
public class Settings_Till {
		...
		float unknownValue = 00;
			...
			public void Till_Settings_Method_open(WebDriver driver2) throws Exception 
			{
				// TODO Auto-generated method stub
				ExcelDataConfig excel = new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
				Thread.sleep(10000);
				//Enter the URL
				driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id")+"newTillSettings");
		...
		if(driver.findElement(By.cssSelector(excel.getData(5, 49, 4))).getText().equalsIgnoreCase("Denomination Saved Successfully"))
		{
		...
		public void	Till_Settings_Select_Search(WebDriver driver) throws Exception
	{
			...
			if(driver.findElement(By.cssSelector(excel.getData(5, 49, 4))).getText().equalsIgnoreCase("Denomination Deleted Successfully"))
			{
