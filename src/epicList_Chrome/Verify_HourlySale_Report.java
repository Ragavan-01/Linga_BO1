	...
	float unknownValue = 00;
		...
		public void calling() throws Exception
		{
			...
			public void Hourly_Sale_method_Report_For_Specific_Date(WebDriver driver) throws Exception
			{
				...
				driver.findElement(By.xpath(excel.getData(3, 1068, 1))).sendKeys("Date Range");
				//Press the Enter Key
		...
		/*		        //Print number of Rows
				        ...
				        if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/div[1]/div[1]/table/tbody/tr["+rows.size()+"]/td[3]")).getText().equals(Utility.getReportProperty("Sale_Report_Net_Sale")))
				        {
				        	...
				        	String actualText1 = driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/div[1]/div[1]/table/tbody/tr["+rows.size()+"]/td[3]")).getText();
						...
						else if(expect1 == unknownValue)
						{
				        	...
				        	String actualText = driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/div[1]/div[1]/table/tbody/tr["+rows.size()+"]/td[3]")).getText();
				        ...
				        if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/div[1]/div[1]/table/tbody/tr["+rows.size()+"]/td[4]")).getText().equals(Utility.getReportProperty("Sale_Report_Tax")))
				        {
				        	test.log(LogStatus.PASS, "Actual and Expected Hourly Sale reports are same for Tax");
				        	
				        	//Get the Total value of Tax
				        	String actualText1 = driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/div[1]/div[1]/table/tbody/tr["+rows.size()+"]/td[4]")).getText();
						...
						else if(expect2 == unknownValue)
						{
				        	...
				        	//Get the Total value of Tax
				        	String actualText = driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/div[1]/div[1]/table/tbody/tr["+rows.size()+"]/td[4]")).getText();
				        ...
				        if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/div[1]/div[1]/table/tbody/tr["+rows.size()+"]/td[6]")).getText().equals(Utility.getReportProperty("Sale_Report_Discount")))
				        {
				        	test.log(LogStatus.PASS, "Actual and Expected Hourly Sale reports are same for Discount");
				        	
				        	//Get the Total value of Discount
				        	String actualText1 = driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/div[1]/div[1]/table/tbody/tr["+rows.size()+"]/td[6]")).getText();
						...
						else if(expect3 == unknownValue)
						{
				        	...
				        	//Get the Total value of Discount
				        	String actualText = driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/div[1]/div[1]/table/tbody/tr["+rows.size()+"]/td[6]")).getText();
				        ...
				        if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/div[1]/div[1]/table/tbody/tr["+rows.size()+"]/td[7]")).getText().equals(Utility.getReportProperty("Sale_Report_Grand_Sale")))
				        {
				        	test.log(LogStatus.PASS, "Actual and Expected Hourly Sale reports are same for Grand Sale");
				        	
				        	//Get the Total value of Grand Sale
				        	String actualText1 = driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/div[1]/div[1]/table/tbody/tr["+rows.size()+"]/td[7]")).getText();
						...
						else if(expect4 == unknownValue)
						{
				        	...
				        	String actualText = driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/div[1]/div[1]/table/tbody/tr["+rows.size()+"]/td[7]")).getText();
				        ...
				        if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/div[1]/div[1]/table/tbody/tr["+rows.size()+"]/td[8]")).getText().equals(Utility.getReportProperty("Hourly_Sale_Report_Number_Of_Customer")))
				        {
				        	...
				        	String actualText1 = driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/div[1]/div[1]/table/tbody/tr["+rows.size()+"]/td[8]")).getText();
						...
						else if(expect5 == unknownValue)
						{
				        	...
				        	//Get the Total value of Number of Customer
				        	String actualText = driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[7]/div/div[1]/div[1]/table/tbody/tr["+rows.size()+"]/td[8]")).getText();
