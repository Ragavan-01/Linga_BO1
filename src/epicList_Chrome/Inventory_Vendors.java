...
public class Inventory_Vendors {
	...
	ExtentTest test = rep.startTest("Inventory_Vendors");
		...
		{  
			...
			if(driver.findElement(By.xpath(excel.getData(3, 1184, 1))).getText().equalsIgnoreCase("Vendor saved successfully"))
			{
		...
		public void Inventory_Vendors_edit_Invetory_Ingredient_Vendor(WebDriver driver) throws Exception
		{
			...
			if(driver.findElement(By.xpath(excel.getData(3, 1184, 1))).getText().equalsIgnoreCase("Vendor updated successfully"))
			{
		...
		public void Inventory_Vendors_delete(WebDriver driver) throws Exception
		{
			...
			if(driver.findElement(By.xpath(excel.getData(3, 1184, 1))).getText().equalsIgnoreCase("Vendor InActivated successfully"))
			{
			...
			if(driver.findElement(By.xpath(excel.getData(3, 1184, 1))).getText().equalsIgnoreCase("Vendor Activated successfully"))
			{
