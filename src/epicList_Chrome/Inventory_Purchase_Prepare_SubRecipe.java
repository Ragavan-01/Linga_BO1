...
/*		//Click the Inventory option
	...
	public void Inventory_Purchase_Prepare_Subrecipe_Update(WebDriver driver) throws Exception
	{
	    ...
	    driver.findElement(By.xpath(excel.getData(3, 1238, 1))).sendKeys("SubRec011");
	  //Enter the SubRecipe option
	 ...
	 driver.findElement(By.xpath(excel.getData(3, 1239, 1))).click();
					
				Thread.sleep(2000);
				//Check New primary storage	page loaded successfully or not
				if(driver.findElement(By.xpath(excel.getData(3, 1240, 1))).getText().equalsIgnoreCase("New Storage"))
				{
			...
			driver.findElement(By.name(excel.getData(3, 1241, 3))).sendKeys(Utility.getProperty("Inventory_Primary_Storage_Name_Prepare_SubRecipe"));	  
			...
			//Click the New primary storage
				...
				driver.findElement(By.cssSelector(excel.getData(3, 1242, 4))).click();
