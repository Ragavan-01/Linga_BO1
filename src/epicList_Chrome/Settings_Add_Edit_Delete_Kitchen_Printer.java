...
/*		//Click the Settings option
	...
	public void Kitchen_Printer_method_add_Kitchen_Printer(WebDriver driver) throws Exception
	{
		...
		//Enter the name
		driver.findElement(By.name(excel.getData(3, 254, 3))).sendKeys("New_Kitch_Print20");
		
		Thread.sleep(1000);
		//Clear the IP Address field 
		driver.findElement(By.name(excel.getData(3, 487, 3))).clear();
		//Enter the IP Address
		driver.findElement(By.name(excel.getData(3, 487, 3))).sendKeys("192.168.1.19");
	...
	public void Kitchen_Printer_method_edit_Kitchen_Printer(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(3, 40, 1))).sendKeys("New_Kitch_Print20");
		...
		//Press Enter button
		driver.findElement(By.xpath(excel.getData(3, 1866, 1))).sendKeys("192.1.1.01");	
		
		Thread.sleep(1000);
		//Clear the name field
		driver.findElement(By.xpath(excel.getData(3,532, 1))).clear();
		//Enter the name
		driver.findElement(By.xpath(excel.getData(3,532, 1))).sendKeys("New_Kitch_Print201");
		
		Thread.sleep(1000);
		//Clear the IP Address field
		driver.findElement(By.xpath(excel.getData(3, 487, 1))).clear();
		//Enter the IP Address
		driver.findElement(By.xpath(excel.getData(3, 487, 1))).sendKeys("192.168.1.19");
...
*/
	...
	public void Kitchen_Printer_method_delete_Kitchen_Printer(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(3, 40, 1))).clear();
		//Enter the required key word
		driver.findElement(By.xpath(excel.getData(3, 40, 1))).sendKeys("New_Kitch_Print201");
