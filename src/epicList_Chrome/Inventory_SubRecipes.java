...
public WebDriver driver;
	...
	ExtentTest test = rep.startTest("Inventory_SubRecipes");
		...
		public void Inventory_Sub_Recipes_edit_Invetory_Sub_Recipe(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath(excel.getData(2, 93, 1))).sendKeys(Utility.getProperty("Inventory_SubRecipe_Name"));
			Thread.sleep(5000);
			//Click the Edit icon
	...
	*/	
		...
		public void Inventory_Sub_Recipes_delete_Invetory_Sub_Recipe(WebDriver driver) throws Exception
		{
			...
			if(driver.findElement(By.xpath(excel.getData(2, 108, 1))).getText().equalsIgnoreCase("inactivated successfully"))
			{
