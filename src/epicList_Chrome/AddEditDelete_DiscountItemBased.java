...
/*		//Click the Products/Items option
	...
	public void Item_Based_Discount_method_addDiscount_ItemBased_ApplicableTimePeriodAsDaysOfWeek(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(0, 220, 1))).click();
		//Enter the required Level
		driver.findElement(By.xpath(excel.getData(0, 221, 1))).sendKeys("Menu item");
		//Press the Enter Key
		driver.findElement(By.xpath(excel.getData(0, 221, 1))).sendKeys(Keys.ENTER);
		
		Thread.sleep(3000);
		//Click the Menu Item Field
		driver.findElement(By.xpath(excel.getData(0, 222, 1))).click();
		//Enter the required Menu Item
		driver.findElement(By.xpath(excel.getData(0, 223, 1))).sendKeys(Keys.ARROW_DOWN);
		//Press the Enter keys
		driver.findElement(By.xpath(excel.getData(0, 223, 1))).sendKeys(Keys.ENTER);	
		Thread.sleep(2000);
		
		Thread.sleep(2000);
		//Check whether the All Serving Size in Menu Item
		if(driver.findElement(By.xpath(excel.getData(0, 224, 1))).isSelected())
		{}
		else
		{
			Thread.sleep(2000);
			driver.findElement(By.xpath(excel.getData(0, 224, 1))).click();
		}
	...
	public void Item_Based_Discount_method_editDiscount_ItemBased(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(0, 221, 1))).sendKeys("Category");
	...
	public void Item_Based_Discount_method_deleteDiscount_ItemBased(WebDriver driver) throws Exception
	{
		...
		if(driver.findElement(By.xpath(excel.getData(0, 39, 1))).getText().equalsIgnoreCase("Discount Inactivated Successfully"))
		{
	...
	public void Item_Based_Discount_method_editDiscount_ItemBased_ApplicableTimePeriodAsAlways_SaveAndPublish(WebDriver driver) throws Exception
	{
		...
		//Click the Level Field
		driver.findElement(By.xpath(excel.getData(0, 239 ,1))).click();
		//Enter the required Level
		driver.findElement(By.xpath(excel.getData(0, 240 ,1))).sendKeys("Sub category");
		//Press the Enter Key
		driver.findElement(By.xpath(excel.getData(0, 240 ,1))).sendKeys(Keys.ENTER);
		Thread.sleep(12000);
		//Click the Menu Item Field
		driver.findElement(By.xpath(excel.getData(0, 241 ,1))).click();
		//Enter the required Menu Item
		driver.findElement(By.xpath(excel.getData(0, 242,1))).sendKeys(Keys.ARROW_DOWN);
		//Press the Enter key
		driver.findElement(By.xpath(excel.getData(0, 242,1))).sendKeys(Keys.ENTER);	
		Thread.sleep(2000);
...
/*		//Click the Level Field
		driver.findElement(By.xpath(excel.getData(0, 239 ,1))).click();
		//Enter the required Level
		driver.findElement(By.xpath(excel.getData(0, 240 ,1))).sendKey("Menu item");
		//Press the Enter Key
		driver.findElement(By.xpath(excel.getData(0, 240 ,1))).sendKey(Keys.ENTER);
		
		//Click the Menu Item Field
		driver.findElement(By.xpath(excel.getData(0, 241 ,1))).click();
		//Enter the required Menu Item
		driver.findElement(By.xpath(excel.getData(0, 242,1))).sendKey("COKE");
		//Press the Enter key
		driver.findElement(By.xpath(excel.getData(0, 242,1))).sendKey(Keys.ENTER);	*/
		Thread.sleep(2000);
