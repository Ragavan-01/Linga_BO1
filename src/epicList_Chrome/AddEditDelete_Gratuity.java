...
public class AddEditDelete_Gratuity {
	...
	if(driver.findElement(By.xpath(excel.getData(4, 23, 1))).getText().equalsIgnoreCase("Gratuities"))
	{
	...
	public void Gratuity_method_addGratuities_Fixed(WebDriver driver) throws Exception
	{
		...
		if(driver.findElement(By.xpath(excel.getData(4, 9, 1))).getText().equalsIgnoreCase("Gratuity saved successfully"))
		{
	...
	public void Gratuity_method_editGratuity(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(4, 10,1))).sendKeys(Utility.getProperty("GratuityName_Fixed")+"1");
		Thread.sleep(4000);driver.findElement(By.xpath(excel.getData(4, 10,1))).sendKeys(Keys.BACK_SPACE);
		driver.findElement(By.xpath(excel.getData(4, 10,1))).sendKeys(Keys.ENTER);
		Thread.sleep(10000);
		//Click the Edit icon
		...
		if(driver.findElement(By.xpath(excel.getData(4, 9,1))).getText().equalsIgnoreCase("Gratuity updated successfully"))
		{
	...
	public void Gratuity_method_deleteGratuity(WebDriver driver) throws Exception
	{
		...
		Thread.sleep(5000);
		//Enter the required keyword
		driver.findElement(By.xpath(excel.getData(4, 10,1))).sendKeys(Utility.getProperty("GratuityName_Fixed")+"11");
		...
		if(driver.findElement(By.xpath(excel.getData(4, 9,1))).getText().equalsIgnoreCase("Gratuity inactivated successfully"))
		{
		...
		if(driver.findElement(By.xpath(excel.getData(4, 9,1))).getText().equalsIgnoreCase("gratuity activated successfully"))
		{
	...
	public void Gratuity_method_closeButton(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(4,16,1))).click();
		
		//Check whether the new discount canceled or not
		if(driver.findElement(By.xpath(excel.getData(4,38,1))).getText().equalsIgnoreCase("Gratuities"))
		{
	...
	public void Gratuity_method_sameName(WebDriver driver) throws Exception
	{
		...
		//Check whether the Product Item updated successfully or not
		if(driver.findElement(By.xpath(excel.getData(4,39,1))).getText().equalsIgnoreCase("Name already exists"))
		{
