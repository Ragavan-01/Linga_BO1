...
/*					String incTax = driver.findElement(By.xpath(excel.getData(3, 1587, 1))).getText();
					...
					Thread.sleep(3000);
					//Get the Total Value
					String gross = driver.findElement(By.xpath(excel.getData(3, 1590, 1))).getText().replaceAll("[a-zA-Z $ ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¹ , :]", "");
					double grossAmt = Double.parseDouble(gross);
				
					//Get the Tax Value
					String tx =  driver.findElement(By.xpath(excel.getData(3, 1591, 1))).getText().replaceAll("[a-zA-Z $ ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¹ , :]", "");
					double txAmt = Double.parseDouble(tx);
				
					//Get the CC Service Charge Value
					String ccs =  driver.findElement(By.xpath(excel.getData(3, 1592, 1))).getText().replaceAll("[a-zA-Z $ ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¹ , :]", "");
					double ccsAmt = Double.parseDouble(ccs);
					
					//Get the Discount Value
					String dis =  driver.findElement(By.xpath(excel.getData(3, 1593, 1))).getText().replaceAll("[a-zA-Z $ ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¹ , :]", "");
