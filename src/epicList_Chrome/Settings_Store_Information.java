...
public class Settings_Store_Information {
	...
	/*		Thread.sleep(13000);
			...
			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id")+"newEdit");
			Thread.sleep(6000);
		...
		public void Store_Information_editpage(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath("//button[contains(text(),'Get My Location')]")).click();
			...
			Thread.sleep(3000);
			driver.findElement(By.xpath("//*[@id='main-container']/div[2]/div/div/div[2]/div[3]/div/div/div[2]/form/div[1]/div[10]/div/div[2]/div")).click();
			Thread.sleep(2000);
			//Enter the required Time Zone 
			driver.findElement(By.xpath("//*[@id='main-container']/div[2]/div/div/div[2]/div[3]/div/div/div[2]/form/div[1]/div[10]/div/div[2]/div/div/div/input")).sendKeys(Utility.getProperty("Settings_Store_Information_TimeZone"));
			//Click the Enter button
			driver.findElement(By.xpath("//*[@id='main-container']/div[2]/div/div/div[2]/div[3]/div/div/div[2]/form/div[1]/div[10]/div/div[2]/div/div/div/input")).sendKeys(Keys.ENTER);
			...
			driver.findElement(By.xpath("//div/ul[@class='chosen-choices']/li/a")).click();
			Thread.sleep(3000);
			//Clear the Languages
			driver.findElement(By.xpath("//div/ul[@class='chosen-choices']")).click();
			//Enter the required Languages
			driver.findElement(By.xpath("//div/ul[@class='chosen-choices']/li/input")).sendKeys(Utility.getProperty("Settings_Store_Information_Language"));
			//Press the Enter button
			driver.findElement(By.xpath("//div/ul[@class='chosen-choices']/li/input")).sendKeys(Keys.ENTER);
			Thread.sleep(2000);
			//Scroll the web page
		    for(int i=1; i <= 10; i++)
		    {
		  ...
		  //Clear the Default Languages
			driver.findElement(By.xpath("//span[.='Select an Option']")).click();
			//Enter the required Languages
			WebElement ele = driver.findElement(By.xpath("//body/div[2]/div[1]/div[1]/div[2]/div[2]/div[1]/div[1]/div[2]/div[3]/div[1]/div[1]/div[2]/form[1]/div[1]/div[12]/div[1]/div[2]/div[1]/div[1]/div[1]/input[1]"));
			ele.sendKeys(Utility.getProperty("Settings_Store_Information_Language"));
			//Press the Enter button
