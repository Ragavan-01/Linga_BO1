...
public class Settings_Store_POSLicenses {
	...
	*/		
			...
			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id")+"newLicense");
			Thread.sleep(5000);
		...
		{			
			...
			for (int i = 1; i <=f; i++) {
				Thread.sleep(2000);
				driver.findElement(By.xpath("//*[@id='main-container']/div[2]/div/div/div[2]/div[3]/div/div/div/div/div[2]/div/div/table/tbody/tr["+f+"]"));
				Thread.sleep(3000);
			...
			//	driver.findElement(By.linkText("Yes")).click();
			    ...
			    Thread.sleep(2000);
				  if(driver.findElement(By.xpath("//div[@role='alert']/span/span")).getText().equalsIgnoreCase("License Unlinked from the device Successfully"))
					...
					{
						test.log(LogStatus.FAIL, "License unlinked Failed");
					} 
