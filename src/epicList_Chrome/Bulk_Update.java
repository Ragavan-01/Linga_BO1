	...
	public void Bulk_Update_edit_menu_Item_Price_SingleServing_Size(WebDriver driver) throws Exception
	{
		...
		for(int i = 1; i <= 20; i++)
		{
			...
			if(inp.size() == 1)
			{
				...
				String actual = driver.findElement(By.xpath(excel.getData(3, 2119, 1))).getText().replaceAll("[a-zA-Z $ ₹ , :]", "");
	...
	public void Bulk_Update_edit_menu_Item_Price_MultipleServing_Size(WebDriver driver) throws Exception
	{
		...
		for(int i = 1; i <= 20; i++)
		{
			...
			if(inp.size() > 1)
			{
				...
				String actual2 = driver.findElement(By.xpath(excel.getData(3, 2121, 1))).getText().replaceAll("[a-zA-Z $ â‚¹ , :]", "");
				...
				String actual3 = driver.findElement(By.xpath(excel.getData(3, 2121, 1))).getText().replaceAll("[a-zA-Z $ â‚¹ , :]", "");
