...
/*		//Check Tax exempt page opened or not
	...
	public void Reasons_PaidOut_method_editPaidOutReasons(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(ex.getData(4, 10, 1))).sendKeys(Utility.getProperty("PaidOutReason")+"1");
		...
		driver.findElement(By.name(ex.getData(4, 6, 3))).clear();
		//Enter the Reasons
		driver.findElement(By.name(ex.getData(4, 6, 3))).sendKeys(Utility.getProperty("PaidOutReason")+"1");
