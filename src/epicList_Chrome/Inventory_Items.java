...
public class Inventory_Items {
	...
	ExtentTest test = rep.startTest("Inventory_Items");
		...
		public void Inventory_item_pagination(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath(excel.getData(3, 1264, 1))).click();
			...
			driver.findElement(By.xpath(excel.getData(3, 1266, 1))).click();
			...
			driver.findElement(By.xpath(excel.getData(3, 1267, 1))).click();
			...
			driver.findElement(By.xpath(excel.getData(3, 1268, 1))).click();
	...
	/*		driver.findElement(By.xpath(excel.getData(3, 1301, 1))).click();
		...
		public void Inventory_Items_edit_Inventory_Items(WebDriver driver) throws Exception
		{
			...
			//Enter the storage location
			driver.findElement(By.xpath(excel.getData(3, 1214, 1))).sendKeys("Syncc");
			//Press the Enter button
		...
		*/
		...
		public void Inventory_Items_delete(WebDriver driver) throws Exception
		{
			...
			if(driver.findElement(By.xpath(excel.getData(3, 39, 1))).getText().equalsIgnoreCase("Inventory item inactivated."))
			{
