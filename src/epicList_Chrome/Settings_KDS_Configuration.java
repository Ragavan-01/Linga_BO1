...
/*		//Click the Settings option
		...
		driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id")+"newKitchenDisplaySystem");
	...
	public void KDS_Configuration_update_KDS_Configuration(WebDriver driver) throws Exception
	{
		...
		if(driver.findElement(By.xpath(excel.getData(3, 1886, 1))).isSelected())
		{
			Thread.sleep(2000);
			//Clear Notification mesaage To Server
			driver.findElement(By.xpath(excel.getData(3, 1887, 1))).clear();
			//Enter Notification mesaage To Server
			driver.findElement(By.xpath(excel.getData(3, 1887, 1))).sendKeys("Hi Server., Your Quick Order ready to Serve");
		}
		else
		{
			Thread.sleep(2000);
		//Enable To Server (Quick Order)
		driver.findElement(By.xpath(excel.getData(3, 1886, 1))).click();
		Thread.sleep(2000);
		//Clear Notification mesaage To server
		driver.findElement(By.xpath(excel.getData(3, 1887, 1))).clear();
		//Enter Notification mesaage To server
		...
		if(driver.findElement(By.xpath(excel.getData(3, 1888, 1))).isSelected())
		{
			...
			//Enter Notification mesaage To Server
			driver.findElement(By.xpath(excel.getData(3, 1889, 1))).sendKeys("Dear Guest., Your Table Service Order is Ready");
		}
		else
		{
		...
		if(driver.findElement(By.xpath(excel.getData(3, 1890, 1))).isSelected())
		{
			//Clear Notification mesaage To Server
			driver.findElement(By.xpath(excel.getData(3, 1891, 1))).clear();
			//Enter Notification mesaage To Server
			driver.findElement(By.xpath(excel.getData(3, 1891, 1))).sendKeys("Hi Server., Your Table Service Order ready to Serve");
		}
		else
		{
		//Enable To Server (Table Service Order)
		driver.findElement(By.xpath(excel.getData(3, 1890, 1))).click();
		Thread.sleep(2000);
		//Clear Notification mesaage To server
		driver.findElement(By.xpath(excel.getData(3, 1891, 1))).clear();
		//Enter Notification mesaage To server
...
if(driver.findElement(By.xpath(excel.getData(3, 1892, 1))).isSelected())
{
	...
	//Enter Notification mesaage To Server
	driver.findElement(By.xpath(excel.getData(3, 1893, 1))).sendKeys("Dear Guest., Your Online Order Order is Ready");
}
else
{
...
driver.findElement(By.xpath(excel.getData(3, 1893, 1))).clear();
//Enter Notification mesaage To Guest
driver.findElement(By.xpath(excel.getData(3, 1893, 1))).sendKeys("Dear Guest., Your Online Order is Ready");
}

Thread.sleep(2000);
//Check whether the To Server Button Enabled or not (For Online Order)
if(driver.findElement(By.xpath(excel.getData(3, 1894, 1))).isSelected())
{
	//Clear Notification mesaage To Server
	driver.findElement(By.xpath(excel.getData(3, 1895, 1))).clear();
	//Enter Notification mesaage To Server
	driver.findElement(By.xpath(excel.getData(3, 1895, 1))).sendKeys("Hi Server., Your Online Order ready to Serve");
}
else
{
//Enable To Server (Online Order)
driver.findElement(By.xpath(excel.getData(3, 1894, 1))).click();
Thread.sleep(2000);
//Clear Notification mesaage To server
driver.findElement(By.xpath(excel.getData(3, 1895, 1))).clear();
//Enter Notification mesaage To server
