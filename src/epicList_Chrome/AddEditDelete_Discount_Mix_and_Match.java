...
/* Create instance of Java script executor
	...
	public void Mix_And_Match_method_addMixandMatch_ApplicableTimePeriodAsAlways(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(5, 162, 1))).click();
		
		//Click the Auto Discount button
		driver.findElement(By.xpath(excel.getData(5, 163, 1))).click();
		
		Thread.sleep(3000);
		//Choose or Click the Category List box
		driver.findElement(By.xpath(excel.getData(5, 164, 1))).click();
		//Enter the required Category
		driver.findElement(By.xpath(excel.getData(5, 165, 1))).sendKeys(Keys.ARROW_DOWN);
		//Press the Enter Key from the keyboard
		driver.findElement(By.xpath(excel.getData(5, 165, 1))).sendKeys(Keys.ENTER);
		
		Thread.sleep(3000);
		//Choose or Click the Menu Items List box
		driver.findElement(By.xpath(excel.getData(5, 166, 1))).click();
		//Enter the required Menu Item
		driver.findElement(By.xpath(excel.getData(5, 167, 1))).sendKeys(Keys.ARROW_DOWN);
		//Press the Enter Key from the keyboard
		driver.findElement(By.xpath(excel.getData(5, 167, 1))).sendKeys(Keys.ENTER);
		...
		driver.findElement(By.xpath(excel.getData(5, 169, 1))).click();
		...
		driver.findElement(By.xpath(excel.getData(5, 172, 1))).click();
		//Click the Close button of latest added option
		driver.findElement(By.xpath(excel.getData(5, 173, 1))).click();
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath(excel.getData(5, 175, 1))).click();
		//Enter the required time option from the given item list
		driver.findElement(By.xpath(excel.getData(5, 176, 1))).sendKeys("Always");
		//Press the Enter Key in the Applicable time period option field
		driver.findElement(By.xpath(excel.getData(5, 176, 1))).sendKeys(Keys.ENTER);
		...
		driver.findElement(By.xpath(excel.getData(5, 179, 1))).click();
		//Enter the required Role
		driver.findElement(By.xpath(excel.getData(5, 179, 1))).sendKeys("Driver");
		//Press the Enter button
		driver.findElement(By.xpath(excel.getData(5, 179, 1))).sendKeys(Keys.ENTER);
	...
	public void Mix_And_Match_method_editMixandMatch(WebDriver driver) throws Exception
	{
		...
		Thread.sleep(3000);
		//Clear the Name field
		driver.findElement(By.xpath(excel.getData(5, 161, 1))).clear();
		//Enter the Name
		driver.findElement(By.xpath(excel.getData(5, 161, 1))).sendKeys(Utility.getProperty("DiscountName_MixAndMatch")+"1");
	...
	public void Mix_And_Match_method_deleteAndActivated_MixandMatch(WebDriver driver) throws Exception
	{
		...
		Thread.sleep(3000);driver.findElement(By.cssSelector(excel.getData(5, 68, 4))).click();
		...
		driver.findElement(By.xpath(excel.getData(5, 185, 1))).click();
		Thread.sleep(3000);
		...
		Thread.sleep(2000);
		//Click the Yes button in the popup
		Thread.sleep(1500);driver.findElement(By.cssSelector(excel.getData(5, 79, 4))).click();
		Thread.sleep(3000);
	...
	public void Mix_And_Match_method_cancelButton(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(5, 161, 1))).clear();
		//Enter the required name    
		driver.findElement(By.xpath(excel.getData(5, 161, 1))).sendKeys(Utility.getProperty("DiscountName_MixAndMatch")+"11");
	...
	public void Mix_And_Match_method_editMixandMatch_ApplicableTimePeriodAsDaysofWeek(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(5, 161, 1))).clear();
		//Enter the required name    
		driver.findElement(By.xpath(excel.getData(5, 161, 1))).sendKeys(Utility.getProperty("DiscountName_MixAndMatch")+"20");
		...
		driver.findElement(By.xpath(excel.getData(5, 175, 1))).click();
		//Enter the required time option from the given item list
		driver.findElement(By.xpath(excel.getData(5, 176, 1))).sendKeys("Days of Week");
		//Press the Enter Key in the Applicable time period option field
		driver.findElement(By.xpath(excel.getData(5, 176, 1))).sendKeys(Keys.ENTER);
		
		//Click the Days of Week Option
		driver.findElement(By.xpath(excel.getData(5, 186, 1))).click();
		//Enter the required DAY for Searching
		driver.findElement(By.xpath(excel.getData(5, 189, 1))).sendKeys("WEDNESDAY");
		//Press the Enter key after enter the keyword
		driver.findElement(By.xpath(excel.getData(5, 189, 1))).sendKeys(Keys.ENTER);
		
		Thread.sleep(2000);
		//Enable or disable the Restriction Time Period option
		driver.findElement(By.xpath(excel.getData(5, 190, 1))).click();
		
		Thread.sleep(3000);
		//Check it is AM or PM in the Start Time Option
		if(driver.findElement(By.xpath(excel.getData(5, 191, 1))).getText().equalsIgnoreCase("AM"))
		{
			Thread.sleep(2000);
			//Click the AM or PM option in the End Time
			driver.findElement(By.xpath(excel.getData(5, 202, 1))).click();
		}
		else
		{
			Thread.sleep(2000);
			//Click the AM or PM option in the Start Time
			driver.findElement(By.xpath(excel.getData(5, 191, 1))).click();
		}
	...
	public void Mix_And_Match_method_editMixandMatch_ApplicableTimePeriodAsDaysOfMonth(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(5, 161, 1))).clear();
		//Enter the required name    
		driver.findElement(By.xpath(excel.getData(5, 161, 1))).sendKeys(Utility.getProperty("DiscountName_MixAndMatch")+"21");
		...
		driver.findElement(By.xpath(excel.getData(5, 164, 1))).click();
		//Enter the required Category
		driver.findElement(By.xpath(excel.getData(5, 165, 1))).click();
		//Press the Enter Key from the keyboard
		driver.findElement(By.xpath(excel.getData(5, 165, 1))).sendKeys(Keys.ENTER);
		...
		driver.findElement(By.xpath(excel.getData(5,  166, 1))).click();
		//Enter the required Menu Item
		driver.findElement(By.xpath(excel.getData(5, 167, 1))).click();
		//Press the Enter Key from the keyboard
		driver.findElement(By.xpath(excel.getData(5, 167, 1))).sendKeys(Keys.ENTER);
		...
		driver.findElement(By.xpath(excel.getData(5, 175, 1))).click();
		//Enter the required time option from the given item list
		driver.findElement(By.xpath(excel.getData(5, 176, 1))).sendKeys("Days of Month");
		//Press the Enter Key in the Applicable time period option field
		driver.findElement(By.xpath(excel.getData(5, 176, 1))).sendKeys(Keys.ENTER);
		
		//Click the Required Date form the Calendar
		driver.findElement(By.xpath(excel.getData(5, 209, 1))).click();
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath(excel.getData(5, 193, 1))).click();
		//Enter the Required month
		driver.findElement(By.xpath(excel.getData(5, 194, 1))).sendKeys("MAY");
		//Press the Enter Key
		driver.findElement(By.xpath(excel.getData(5, 194, 1))).sendKeys(Keys.ENTER);
		
		//Enable or Disable the Restriction Time option
		driver.findElement(By.xpath(excel.getData(5, 195, 1))).click();
		Thread.sleep(2000);
		//Check it is AM or PM in the Start Time Option
		if(driver.findElement(By.xpath(excel.getData(5, 210, 1))).getText().equalsIgnoreCase("AM"))
		{
			Thread.sleep(2000);
			//Click the AM or PM option in the End Time
			driver.findElement(By.xpath(excel.getData(5, 196, 1))).click();
		}
		else
		{
			Thread.sleep(2000);
			//Click the AM or PM option in the Start Time
			driver.findElement(By.xpath(excel.getData(5, 210, 1))).click();
		}
	...
	public void Mix_And_Match_method_editMixandMatch_ApplicableTimePeriodAsDateRange(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(5, 161, 1))).clear();
		//Enter the required name    
		driver.findElement(By.xpath(excel.getData(5, 161, 1))).sendKeys(Utility.getProperty("DiscountName_MixAndMatch")+"22");
		...
		driver.findElement(By.xpath(excel.getData(5, 175, 1))).click();
		//Enter the required time option from the given item list
		driver.findElement(By.xpath(excel.getData(5, 176, 1))).sendKeys("Date Range");
		//Press the Enter Key in the Applicable time period option field
		driver.findElement(By.xpath(excel.getData(5, 176, 1))).sendKeys(Keys.ENTER);
		...
		driver.findElement(By.xpath(excel.getData(5, 197, 1))).click();
		
		Thread.sleep(2000);
		//Click the Days of a Week option
		driver.findElement(By.xpath(excel.getData(5, 198, 1))).click();
		//Enter the Required Date
		driver.findElement(By.xpath(excel.getData(5, 199, 1))).sendKeys("FRIDAY");
		//Press the Enter Key
		driver.findElement(By.xpath(excel.getData(5, 199, 1))).sendKeys(Keys.ENTER);

		//Enable or Disable the Restriction Time option
		driver.findElement(By.xpath(excel.getData(5, 205, 1))).click();
		
		//Check it is AM or PM in the Start Time Option
		if(driver.findElement(By.xpath(excel.getData(5, 206, 1))).getText().equalsIgnoreCase("AM"))
		{
			Thread.sleep(2000);
			//Click the AM or PM option in the End Time
			driver.findElement(By.xpath(excel.getData(5, 207, 1))).click();
		}
		else
		{
			Thread.sleep(2000);
			//Click the AM or PM option in the Start Time
			driver.findElement(By.xpath(excel.getData(5, 206, 1))).click();
		}
	...
	public void Mix_And_Match_method_editMixandMatch_ApplicableTimePeriodAsSpecificDate(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(5, 161, 1))).clear();
		//Enter the required name    
		driver.findElement(By.xpath(excel.getData(5, 161, 1))).sendKeys(Utility.getProperty("DiscountName_MixAndMatch")+"23");
...
/*		Thread.sleep(2000);
		...
		driver.findElement(By.xpath(excel.getData(5, 175, 1))).click();
		//Enter the required time option from the given item list
		driver.findElement(By.xpath(excel.getData(5, 176, 1))).sendKeys("Specific date");
		//Press the Enter Key in the Applicable time period option field
		driver.findElement(By.xpath(excel.getData(5, 176, 1))).sendKeys(Keys.ENTER);
	...
	public void Mix_And_Match_method_editMixandMatch_ApplicableTimePeriodAsStartDateTimeAndEndDateTime(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(5, 161, 1))).clear();
		//Enter the required name    
		driver.findElement(By.xpath(excel.getData(5, 161, 1))).sendKeys(Utility.getProperty("DiscountName_MixAndMatch")+"24");
...
*/		//Press the Enter Key from the keyboard
		...
		driver.findElement(By.xpath(excel.getData(5, 175, 1))).click();
		//Enter the required time option from the given item list
		driver.findElement(By.xpath(excel.getData(5, 176, 1))).sendKeys("Start date time & end date time");
		//Press the Enter Key in the Applicable time period option field
		driver.findElement(By.xpath(excel.getData(5, 176, 1))).sendKeys(Keys.ENTER);
