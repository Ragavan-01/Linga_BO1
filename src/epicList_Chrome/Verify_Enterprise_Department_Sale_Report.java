...
public class Verify_Enterprise_Department_Sale_Report {
	...
	ExtentTest test = rep.startTest("Verify_Enterprise_Department_Sale_Report");
	...
	float unknownValue = 00;
		...
		public void calling() throws Exception
		{
			...
			Thread.sleep(1000);
			Enterprise_Department_Report_Method_For_openpage(driver);
			Enterprise_Department_Report_Method_For_Stores(driver);
			Enterprise_Department_Report_Method_For_Group(driver);
			Enterprise_Department_Report_Method_For_City(driver);
			Enterprise_Department_Report_Method_For_State(driver);
			Enterprise_Department_Report_Method_For_ZipCode(driver);
			Thread.sleep(1500);
		}
		...
		public void Enterprise_Department_Report_Method_For_Stores(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath(excel.getData(3, 700, 1))).click();
			//Enter the required option
			driver.findElement(By.xpath(excel.getData(3, 701, 1))).sendKeys("Date Range");
			//Press the Enter button
			driver.findElement(By.xpath(excel.getData(3, 701, 1))).sendKeys(Keys.ENTER);
		
			//Clear the date field
			driver.findElement(By.xpath(excel.getData(3, 702, 1))).clear();
			//Enter the required date
			driver.findElement(By.xpath(excel.getData(3, 702, 1))).sendKeys(Utility.getReportProperty("Date_Range_From"));

			//Clear the date field
			driver.findElement(By.xpath(excel.getData(3, 703, 1))).clear();
			//Enter the required date
			driver.findElement(By.xpath(excel.getData(3, 703, 1))).sendKeys(Utility.getReportProperty("Date_Range_To"));
