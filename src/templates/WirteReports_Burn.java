...
public class WirteReports_Burn{
...
/*				//Check if we logged in or not
	...
	public void all() throws Exception
	{
		for(int a = 13; a <= 20; a++)
		{
			...
			getTheValue_Of_Sale_Recap_Report(fdate);
			getTheValue_Of_Department_Sale_Report(fdate);
			getTheValue_Of_Category_Sale_Report(fdate);
			getTheValue_Of_Sub_Category_Sale_Report(fdate);
			getTheValue_Of_Menu_Item_Sale_Report(fdate);
			getTheValue_Of_Modifier_Sale_Report(fdate);
			getTheValue_Of_Hourly_Sale_Report(fdate);
			getTheValue_Of_Daily_Sale_Report(fdate);
			getTheValue_Of_Cashier_Report(fdate);
			getTheValue_Of_Sale_Summary_Report(fdate);
			getTheValue_Of_Transaction_Report(fdate);
			getTheValue_Of_Tax_Report(fdate);
			getTheValue_Of_Payroll_Report(fdate);
			diff(fdate);
	...
	public void apply_Not_Applicable(String fdate) throws Exception
	{
		...
		sheet1.getRow(1).createCell(0).setCellValue(fdate);
		for(int i = 1; i <= 30; i++)
		{
			for(int j = 2; j <= 14; j++)
			{
	...
	public void getTheValue_Of_Sale_Recap_Report(String fdate) throws Exception
	{
		File src = new File(Utility.getProperty("Excel_Sheet_Path"));
		...
		//Enter the date
		driver.findElement(By.xpath("//form[@name='saleReport']/div[4]/div/div/input[1]")).sendKeys(fdate);

		Thread.sleep(2000);
		//Clear the date field
		driver.findElement(By.xpath("//form[@name='saleReport']/div[4]/div/div/input[2]")).clear();
		//Enter the date
		driver.findElement(By.xpath("//form[@name='saleReport']/div[4]/div/div/input[2]")).sendKeys(fdate);
	...
	public void getTheValue_Of_Department_Sale_Report(String fdate) throws Exception
	{
		...
		//Enter the date
		driver.findElement(By.xpath("//form[@name='saleReport']/div[3]/div/div/input[1]")).sendKeys(fdate);

		Thread.sleep(2000);
		//Clear the date field
		driver.findElement(By.xpath("//form[@name='saleReport']/div[3]/div/div/input[2]")).clear();
		//Enter the date
		driver.findElement(By.xpath("//form[@name='saleReport']/div[3]/div/div/input[2]")).sendKeys(fdate);
	...
	public void getTheValue_Of_Category_Sale_Report(String fdate) throws Exception
	{
	...
	public void getTheValue_Of_Sub_Category_Sale_Report(String fdate) throws Exception
	{
	...
	public void getTheValue_Of_Menu_Item_Sale_Report(String fdate) throws Exception
	{
		...
		//Enter the date
		driver.findElement(By.xpath("//form[@name='saleReport']/div[8]/div/div/input[1]")).sendKeys(fdate);
		
		Thread.sleep(2000);
		//Clear the date field
		driver.findElement(By.xpath("//form[@name='saleReport']/div[8]/div/div/input[2]")).clear();
		//Enter the date
		driver.findElement(By.xpath("//form[@name='saleReport']/div[8]/div/div/input[2]")).sendKeys(fdate);
	...
	public void getTheValue_Of_Modifier_Sale_Report(String fdate) throws Exception
	{
	...
	public void getTheValue_Of_Hourly_Sale_Report(String fdate) throws Exception
	{
		...
		//Enter the date
		driver.findElement(By.xpath("//form[@name='saleReport']/div[2]/div/div/input[1]")).sendKeys(fdate);

		Thread.sleep(2000);
		//Clear the date field
		driver.findElement(By.xpath("//form[@name='saleReport']/div[2]/div/div/input[2]")).clear();
		//Enter the date
		driver.findElement(By.xpath("//form[@name='saleReport']/div[2]/div/div/input[2]")).sendKeys(fdate);
	...
	public void getTheValue_Of_Daily_Sale_Report(String fdate) throws Exception
	{
	...
	public void getTheValue_Of_Cashier_Report(String fdate) throws Exception
	{
	...
	public void getTheValue_Of_Sale_Summary_Report(String fdate) throws Exception
	{
...
*/		
	...
	public void getTheValue_Of_Transaction_Report(String fdate) throws Exception
	{
		...
		//Enter the date
		driver.findElement(By.xpath("//form[@name='transactionSale']/div[4]/div/div/input[1]")).sendKeys(fdate);

		Thread.sleep(2000);
		//Clear the date field
		driver.findElement(By.xpath("//form[@name='transactionSale']/div[4]/div/div/input[2]")).clear();
		//Enter the date
		driver.findElement(By.xpath("//form[@name='transactionSale']/div[4]/div/div/input[2]")).sendKeys(fdate);
	...
	public void getTheValue_Of_Tax_Report(String fdate) throws Exception
	{
	    ...
	    driver.findElement(By.xpath("//form[@name='taxReport']/div[2]/div/div/input[1]")).sendKeys(fdate);

	    //Clear the Date field
	    driver.findElement(By.xpath("//form[@name='taxReport']/div[2]/div/div/input[2]")).clear();
	    //Enter the required date
	    driver.findElement(By.xpath("//form[@name='taxReport']/div[2]/div/div/input[2]")).sendKeys(fdate);
	...
	public void getTheValue_Of_Payroll_Report(String fdate) throws Exception
	{
	    ...
	    //Enter the Date
	    driver.findElement(By.xpath("//form[@name='payRoll']/div[4]/div/div/input[1]")).sendKeys(fdate);

	    Thread.sleep(1000);
	    //Clear the Date field
	    driver.findElement(By.xpath("//form[@name='payRoll']/div[4]/div/div/input[2]")).clear();
	    //Enter the Date
	    driver.findElement(By.xpath("//form[@name='payRoll']/div[4]/div/div/input[2]")).sendKeys(fdate);
	    Thread.sleep(1000);
	...
	public void diff(String fdate) throws Exception
	{		
		File src = new File(Utility.getProperty("Excel_Sheet_Path"));
