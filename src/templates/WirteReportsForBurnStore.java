...
public class WirteReportsForBurnStore{
	...
	public void login_Ridgway() throws Exception
	{
...
/*				//Check if we logged in or not
	...
	public void logout_Ridgway() throws Exception
	{
...
/*	@Test(priority=2)
	public void burnStore()
	{
		for(int a = 13; a <= 31; a++)
		{
			DecimalFormat formatter = new DecimalFormat("00");
			String aFormatted = formatter.format(a);
			String fdate = aFormatted+"-Mar-2019";
	...
	public void apply_Not_Applicable() throws Exception
	{
		...
		sheet2.getRow(1).createCell(0).setCellValue(Utility.getReportProperty("Date_Range_From"));
		sheet3.getRow(1).createCell(0).setCellValue(Utility.getReportProperty("Date_Range_From"));
		sheet4.getRow(1).createCell(0).setCellValue(Utility.getReportProperty("Date_Range_From"));
		sheet5.getRow(1).createCell(0).setCellValue(Utility.getReportProperty("Date_Range_From"));
		...
		for(int i = 1; i <= 30; i++)
		{
			for(int j = 2; j <= 14; j++)
			{
				...
				sheet2.getRow(j).createCell(i).setCellValue("-");
				sheet3.getRow(j).createCell(i).setCellValue("-");
				sheet4.getRow(j).createCell(i).setCellValue("-");
				sheet5.getRow(j).createCell(i).setCellValue("-");
			}
	...
	public void getTheValue_Of_Sale_Recap_Report_Ridgway() throws Exception
	{
		File src = new File(Utility.getProperty("Excel_Sheet_Path"));
		...
		driver.get(Utility.getProperty("baseURL")+"5b97c61f0641790001b87ce6/report/saleRecap");
	...
	public void getTheValue_Of_Department_Sale_Report_Ridgway() throws Exception
	{
		...
		driver.get(Utility.getProperty("baseURL")+"5b97c61f0641790001b87ce6/report/departmentSale");
	...
	public void getTheValue_Of_Category_Sale_Report_Ridgway() throws Exception
	{
		...
		driver.get(Utility.getProperty("baseURL")+"5b97c61f0641790001b87ce6/report/categorySale");
	...
	public void getTheValue_Of_Sub_Category_Sale_Report_Ridgway() throws Exception
	{
		...
		driver.get(Utility.getProperty("baseURL")+"5b97c61f0641790001b87ce6/report/subCategorySale");
	...
	public void getTheValue_Of_Menu_Item_Sale_Report_Ridgway() throws Exception
	{
		...
		driver.get(Utility.getProperty("baseURL")+"5b97c61f0641790001b87ce6/report/menuItemSale");
	...
	public void getTheValue_Of_Modifier_Sale_Report_Ridgway() throws Exception
	{
		...
		driver.get(Utility.getProperty("baseURL")+"5b97c61f0641790001b87ce6/report/modifierSale");
	...
	public void getTheValue_Of_Hourly_Sale_Report_Ridgway() throws Exception
	{
		...
		driver.get(Utility.getProperty("baseURL")+"5b97c61f0641790001b87ce6/report/hourlySale");
	...
	public void getTheValue_Of_Daily_Sale_Report_Ridgway() throws Exception
	{
		...
		driver.get(Utility.getProperty("baseURL")+"5b97c61f0641790001b87ce6/report/dailySale");
	...
	public void getTheValue_Of_Cashier_Report_Ridgway() throws Exception
	{
	...
	public void getTheValue_Of_Sale_Summary_Report_Ridgway() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the Daily Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5b97c61f0641790001b87ce6/report/saleSummary");
	...
	public void getTheValue_Of_Transaction_Report_Ridgway() throws Exception
	{
		...
		driver.get(Utility.getProperty("baseURL")+"5b97c61f0641790001b87ce6/report/transactionSale");
	...
	public void getTheValue_Of_Tax_Report_Ridgway() throws Exception
	{
		...
		driver.get(Utility.getProperty("baseURL")+"5b97c61f0641790001b87ce6/taxReport");
	...
	public void getTheValue_Of_Payroll_Report_Ridgway() throws Exception
	{
		...
		driver.get(Utility.getProperty("baseURL")+"5b97c61f0641790001b87ce6/roleBasedPayroll");
	...
	public void diff_Ridgway() throws Exception
	{		
		File src = new File(Utility.getProperty("Excel_Sheet_Path"));
	...
	public void login_Bevy() throws Exception
	{
				...
				driver.findElement(By.name("txtusername")).clear();
				//Enter the user name
				driver.findElement(By.name("txtusername")).sendKeys("support@bevy.com");
				//Clear the password from the password text box
				driver.findElement(By.name("txtpassword")).clear();
				//Enter the password
				driver.findElement(By.name("txtpassword")).sendKeys("linga123");
	...
	public void logout_Bevy() throws Exception
	{
		if(Utility.getProperty("Product").equalsIgnoreCase("UPOS"))
		{
		JavascriptExecutor je = (JavascriptExecutor) driver;
	...
	public void getTheValue_Of_Sale_Recap_Report_Bevy() throws Exception
	{
		File src = new File(Utility.getProperty("Excel_Sheet_Path"));
		...
		Thread.sleep(8000);
		//Enter the SaleRecap Url
		driver.get(Utility.getProperty("baseURL")+"5bbf6b113be9f20001bb60be/report/saleRecap");
	...
	public void getTheValue_Of_Department_Sale_Report_Bevy() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the department Sale Url
		driver.get(Utility.getProperty("baseURL")+"5bbf6b113be9f20001bb60be/report/departmentSale");
	...
	public void getTheValue_Of_Category_Sale_Report_Bevy() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the category Sale Url
		driver.get(Utility.getProperty("baseURL")+"5bbf6b113be9f20001bb60be/report/categorySale");
	...
	public void getTheValue_Of_Sub_Category_Sale_Report_Bevy() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the sub category Sale Url
		driver.get(Utility.getProperty("baseURL")+"5bbf6b113be9f20001bb60be/report/subCategorySale");
	...
	public void getTheValue_Of_Menu_Item_Sale_Report_Bevy() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the menu item Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5bbf6b113be9f20001bb60be/report/menuItemSale");
	...
	public void getTheValue_Of_Modifier_Sale_Report_Bevy() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the modifier Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5bbf6b113be9f20001bb60be/report/modifierSale");
	...
	public void getTheValue_Of_Hourly_Sale_Report_Bevy() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the hourly Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5bbf6b113be9f20001bb60be/report/hourlySale");
	...
	public void getTheValue_Of_Daily_Sale_Report_Bevy() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the Daily Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5bbf6b113be9f20001bb60be/report/dailySale");
	...
	public void getTheValue_Of_Cashier_Report_Bevy() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the cashierOut Url
		driver.get(Utility.getProperty("baseURL")+"5bbf6b113be9f20001bb60be/report/cashierOut");
	...
	public void getTheValue_Of_Sale_Summary_Report_Bevy() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the Daily Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5bbf6b113be9f20001bb60be/report/saleSummary");
	...
	public void getTheValue_Of_Transaction_Report_Bevy() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the transactionSale report Url
		driver.get(Utility.getProperty("baseURL")+"5bbf6b113be9f20001bb60be/report/transactionSale");
	...
	public void getTheValue_Of_Tax_Report_Bevy() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the taxReport report Url
		driver.get(Utility.getProperty("baseURL")+"5bbf6b113be9f20001bb60be/taxReport");
	...
	public void getTheValue_Of_Payroll_Report_Bevy() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the roleBasedPayroll report Url
		driver.get(Utility.getProperty("baseURL")+"5bbf6b113be9f20001bb60be/roleBasedPayroll");
	...
	public void diff_Bevy() throws Exception
	{		
		File src = new File(Utility.getProperty("Excel_Sheet_Path"));
	...
	public void login_Hide() throws Exception
	{
				...
				driver.findElement(By.name("txtusername")).clear();
				//Enter the user name
				driver.findElement(By.name("txtusername")).sendKeys("admin@hide.com");
				//Clear the password from the password text box
				driver.findElement(By.name("txtpassword")).clear();
				//Enter the password
				driver.findElement(By.name("txtpassword")).sendKeys("linga123");
...
/*				//Check if we logged in or not
	...
	public void logout_Hide() throws Exception
	{
		if(Utility.getProperty("Product").equalsIgnoreCase("UPOS"))
		{
		JavascriptExecutor je = (JavascriptExecutor) driver;
	...
	public void getTheValue_Of_Sale_Recap_Report_Hide() throws Exception
	{
		File src = new File(Utility.getProperty("Excel_Sheet_Path"));
		...
		Thread.sleep(8000);
		//Enter the SaleRecap Url
		driver.get(Utility.getProperty("baseURL")+"5a6c9f7308811a0c3496525e/report/saleRecap");
		...
		try{
			...
			//Get the Total Tax Amount
			String total_tax = driver.findElement(By.xpath("//b[.='TAXES']/../../../div[contains(.,'TOTAL')]/span")).getText();
			//double netSaleAmount = Double.parseDouble(netSales);
			sheet1.getRow(2).createCell(14).setCellValue(total_tax);
		}
		...
		{
			//Get the Total Tax Exempt Amount
			String total_tax_exempt = driver.findElement(By.xpath("//b[.='TAXES']/../../../div[contains(.,'TAX EXEMPT')]/span")).getText();
			//double netSaleAmount = Double.parseDouble(netSales);
			sheet1.getRow(2).createCell(18).setCellValue(total_tax_exempt);
		}catch(Exception e){}
	...
	public void getTheValue_Of_Department_Sale_Report_Hide() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the department Sale Url
		driver.get(Utility.getProperty("baseURL")+"5a6c9f7308811a0c3496525e/report/departmentSale");
	...
	public void getTheValue_Of_Category_Sale_Report_Hide() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the category Sale Url
		driver.get(Utility.getProperty("baseURL")+"5a6c9f7308811a0c3496525e/report/categorySale");
	...
	public void getTheValue_Of_Sub_Category_Sale_Report_Hide() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the sub category Sale Url
		driver.get(Utility.getProperty("baseURL")+"5a6c9f7308811a0c3496525e/report/subCategorySale");
	...
	public void getTheValue_Of_Menu_Item_Sale_Report_Hide() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the menu item Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5a6c9f7308811a0c3496525e/report/menuItemSale");
	...
	public void getTheValue_Of_Modifier_Sale_Report_Hide() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the modifier Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5a6c9f7308811a0c3496525e/report/modifierSale");
	...
	public void getTheValue_Of_Hourly_Sale_Report_Hide() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the hourly Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5a6c9f7308811a0c3496525e/report/hourlySale");
	...
	public void getTheValue_Of_Daily_Sale_Report_Hide() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the Daily Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5a6c9f7308811a0c3496525e/report/dailySale");
	...
	public void getTheValue_Of_Cashier_Report_Hide() throws Exception
	{		
		File src = new File(Utility.getProperty("Excel_Sheet_Path"));
		...
		Thread.sleep(3000);
		//Enter the cashierOut Url
		driver.get(Utility.getProperty("baseURL")+"5a6c9f7308811a0c3496525e/report/cashierOut");
	...
	public void getTheValue_Of_Sale_Summary_Report_Hide() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the Daily Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5a6c9f7308811a0c3496525e/report/saleSummary");
...
*/		
	...
	public void getTheValue_Of_Transaction_Report_Hide() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the transactionSale report Url
		driver.get(Utility.getProperty("baseURL")+"5a6c9f7308811a0c3496525e/report/transactionSale");
	...
	/*		//Get the Tax Amount
			String tax_Amount = driver.findElement(By.xpath("//table[@class='table table-bordered ng-table-responsive table-condensed ng-scope ng-table']/tbody/tr["+rowco+"]/td[4]/span")).getText();
			//double netSaleAmount = Double.parseDouble(netSales);
			sheet1.getRow(11).createCell(14).setCellValue(tax_Amount);*/
		}		
		FileOutputStream fout = new FileOutputStream(src);
	...
	public void getTheValue_Of_Tax_Report_Hide() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the taxReport report Url
		driver.get(Utility.getProperty("baseURL")+"5a6c9f7308811a0c3496525e/taxReport");
	...
	public void getTheValue_Of_Payroll_Report_Hide() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the roleBasedPayroll report Url
		driver.get(Utility.getProperty("baseURL")+"5a6c9f7308811a0c3496525e/roleBasedPayroll");
	...
	public void diff_Hide() throws Exception
	{		
		File src = new File(Utility.getProperty("Excel_Sheet_Path"));
		...
		for(int j = 2; j <= 14; j++)
		{
			...
			String nsale = sheet1.getRow(j).getCell(1).getStringCellValue().replace(".", "").replace(",", ".");
			double netsale = Double.parseDouble(nsale);
			sheet1.getRow(j).createCell(1).setCellValue(netsale);
			}
		}
		for(int j = 2; j <= 14; j++)
		{
			...
			String dnsale = sheet1.getRow(j).getCell(29).getStringCellValue().replace(".", "").replace(",", ".");
			//dnsale = sheet1.getRow(j).getCell(29).getStringCellValue().replaceAll(",", ".");q
			double dnetsale = Double.parseDouble(dnsale);
			sheet1.getRow(j).createCell(29).setCellValue(dnetsale);
			}
		}
		for(int j = 2; j <= 14; j++)
		{
			...
			String cnsale = sheet1.getRow(j).getCell(30).getStringCellValue().replace(".", "").replace(",", ".");
			//cnsale = sheet1.getRow(j).getCell(30).getStringCellValue().replaceAll(",", ".");q
			double cnetsale = Double.parseDouble(cnsale);
			sheet1.getRow(j).createCell(30).setCellValue(cnetsale);
			}
		}
		for(int j = 2; j <= 14; j++)
		{
			...
			String tax = sheet1.getRow(j).getCell(14).getStringCellValue().replace(".", "").replace(",", ".");
			//tax = sheet1.getRow(j).getCell(14).getStringCellValue().replaceAll(",", ".");q
			double ttax = Double.parseDouble(tax);
			sheet1.getRow(j).createCell(14).setCellValue(ttax);
			}
		}		
		for(int j = 2; j <= 14; j++)
		{
			...
			String taxexempt = sheet1.getRow(j).getCell(18).getStringCellValue().replace(".", "").replace(",", ".");
			//taxexempt = sheet1.getRow(j).getCell(18).getStringCellValue().replaceAll(",", ".");q
			double ttaxexempt = Double.parseDouble(taxexempt);
			sheet1.getRow(j).createCell(18).setCellValue(ttaxexempt);
			}
		}
		for(int j = 2; j <= 14; j++)
		{
			...
			String ccSales = sheet1.getRow(j).getCell(19).getStringCellValue().replace(".", "").replace(",", ".");
			//ccSales = sheet1.getRow(j).getCell(19).getStringCellValue().replaceAll(",", ".");q
			double tccSales = Double.parseDouble(ccSales);
			sheet1.getRow(j).createCell(19).setCellValue(tccSales);
			}
		}
		for(int j = 2; j <= 14; j++)
		{
			...
			String tips = sheet1.getRow(j).getCell(20).getStringCellValue().replace(".", "").replace(",", ".");
			//tips = sheet1.getRow(j).getCell(20).getStringCellValue().replaceAll(",", ".");q
			double ttips = Double.parseDouble(tips);
			sheet1.getRow(j).createCell(20).setCellValue(ttips);
			}
		}
		for(int j = 2; j <= 14; j++)
		{
			...
			String gratuity = sheet1.getRow(j).getCell(21).getStringCellValue().replace(".", "").replace(",", ".");
			//gratuity = sheet1.getRow(j).getCell(21).getStringCellValue().replaceAll(",", ".");q
			double tgratuity = Double.parseDouble(gratuity);
			sheet1.getRow(j).createCell(21).setCellValue(tgratuity);
			}
		}
		for(int j = 2; j <= 14; j++)
		{
			...
			String disc_amount = sheet1.getRow(j).getCell(28).getStringCellValue().replace(".", "").replace(",", ".");
			//disc_amount = sheet1.getRow(j).getCell(28).getStringCellValue().replaceAll(",", ".");q
			double tdisc_amount = Double.parseDouble(disc_amount);
			sheet1.getRow(j).createCell(28).setCellValue(tdisc_amount);
			}
		}
	...
	public void login_Aldar() throws Exception
	{
				...
				driver.findElement(By.name("txtusername")).clear();
				//Enter the user name
				driver.findElement(By.name("txtusername")).sendKeys("admin@aldar.com");
				//Clear the password from the password text box
				driver.findElement(By.name("txtpassword")).clear();
				//Enter the password
...
/*				//Check if we logged in or not
	...
	public void logout_Aldar() throws Exception
	{
		if(Utility.getProperty("Product").equalsIgnoreCase("UPOS"))
		{
		JavascriptExecutor je = (JavascriptExecutor) driver;
	...
	public void getTheValue_Of_Sale_Recap_Report_Aldar() throws Exception
	{
		File src = new File(Utility.getProperty("Excel_Sheet_Path"));
		...
		Thread.sleep(8000);
		//Enter the SaleRecap Url
		driver.get(Utility.getProperty("baseURL")+"5a9266e208811a23c93a2da7/report/saleRecap");
	...
	public void getTheValue_Of_Department_Sale_Report_Aldar() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the department Sale Url
		driver.get(Utility.getProperty("baseURL")+"5a9266e208811a23c93a2da7/report/departmentSale");
	...
	public void getTheValue_Of_Category_Sale_Report_Aldar() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the category Sale Url
		driver.get(Utility.getProperty("baseURL")+"5a9266e208811a23c93a2da7/report/categorySale");
	...
	public void getTheValue_Of_Sub_Category_Sale_Report_Aldar() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the sub category Sale Url
		driver.get(Utility.getProperty("baseURL")+"5a9266e208811a23c93a2da7/report/subCategorySale");
	...
	public void getTheValue_Of_Menu_Item_Sale_Report_Aldar() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the menu item Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5a9266e208811a23c93a2da7/report/menuItemSale");
	...
	public void getTheValue_Of_Modifier_Sale_Report_Aldar() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the modifier Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5a9266e208811a23c93a2da7/report/modifierSale");
	...
	public void getTheValue_Of_Hourly_Sale_Report_Aldar() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the hourly Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5a9266e208811a23c93a2da7/report/hourlySale");
	...
	public void getTheValue_Of_Daily_Sale_Report_Aldar() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the Daily Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5a9266e208811a23c93a2da7/report/dailySale");
	...
	public void getTheValue_Of_Cashier_Report_Aldar() throws Exception
	{		
		File src = new File(Utility.getProperty("Excel_Sheet_Path"));
		...
		Thread.sleep(3000);
		//Enter the cashierOut Url
		driver.get(Utility.getProperty("baseURL")+"5a9266e208811a23c93a2da7/report/cashierOut");
	...
	public void getTheValue_Of_Sale_Summary_Report_Aldar() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the Daily Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5a9266e208811a23c93a2da7/report/saleSummary");
...
*/		
	...
	public void getTheValue_Of_Transaction_Report_Aldar() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the transactionSale report Url
		driver.get(Utility.getProperty("baseURL")+"5a9266e208811a23c93a2da7/report/transactionSale");
	...
	public void getTheValue_Of_Tax_Report_Aldar() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the taxReport report Url
		driver.get(Utility.getProperty("baseURL")+"5a9266e208811a23c93a2da7/taxReport");
	...
	public void getTheValue_Of_Payroll_Report_Aldar() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the roleBasedPayroll report Url
		driver.get(Utility.getProperty("baseURL")+"5a9266e208811a23c93a2da7/roleBasedPayroll");
	...
	public void diff_Aldar() throws Exception
	{		
		File src = new File(Utility.getProperty("Excel_Sheet_Path"));
		...
		for(int j = 2; j <= 14; j++)
		{
			...
			String nsale = sheet1.getRow(j).getCell(1).getStringCellValue().replace(".", "").replace(",", ".");
			//nsale = sheet1.getRow(j).getCell(1).getStringCellValue().replaceAll(",", ".");q
			double netsale = Double.parseDouble(nsale);
			sheet1.getRow(j).createCell(1).setCellValue(netsale);
			}
		}
	...
	public void login_Austin() throws Exception
	{
...
/*				//Check if we logged in or not
	...
	public void logout_Austin() throws Exception
	{
		if(Utility.getProperty("Product").equalsIgnoreCase("UPOS"))
		{
		JavascriptExecutor je = (JavascriptExecutor) driver;
	...
	public void getTheValue_Of_Sale_Recap_Report_Austin() throws Exception
	{
		File src = new File(Utility.getProperty("Excel_Sheet_Path"));
		...
		XSSFSheet sheet1 = wb.getSheetAt(4);
		
		Thread.sleep(8000);
		//Enter the SaleRecap Url
		driver.get(Utility.getProperty("baseURL")+"5c41e5dd90d88f0001d47213/report/saleRecap");
	...
	public void getTheValue_Of_Department_Sale_Report_Austin() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the department Sale Url
		driver.get(Utility.getProperty("baseURL")+"5c41e5dd90d88f0001d47213/report/departmentSale");
	...
	public void getTheValue_Of_Category_Sale_Report_Austin() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the category Sale Url
		driver.get(Utility.getProperty("baseURL")+"5c41e5dd90d88f0001d47213/report/categorySale");
	...
	public void getTheValue_Of_Sub_Category_Sale_Report_Austin() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the sub category Sale Url
		driver.get(Utility.getProperty("baseURL")+"5c41e5dd90d88f0001d47213/report/subCategorySale");
	...
	public void getTheValue_Of_Menu_Item_Sale_Report_Austin() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the menu item Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5c41e5dd90d88f0001d47213/report/menuItemSale");
	...
	public void getTheValue_Of_Modifier_Sale_Report_Austin() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the modifier Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5c41e5dd90d88f0001d47213/report/modifierSale");
	...
	public void getTheValue_Of_Hourly_Sale_Report_Austin() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the hourly Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5c41e5dd90d88f0001d47213/report/hourlySale");
	...
	public void getTheValue_Of_Daily_Sale_Report_Austin() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the Daily Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5c41e5dd90d88f0001d47213/report/dailySale");
	...
	public void getTheValue_Of_Cashier_Report_Austin() throws Exception
	{		
		File src = new File(Utility.getProperty("Excel_Sheet_Path"));
	...
	public void getTheValue_Of_Sale_Summary_Report_Austin() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the Daily Sale report Url
		driver.get(Utility.getProperty("baseURL")+"5c41e5dd90d88f0001d47213/report/saleSummary");
...
*/		
	...
	public void getTheValue_Of_Transaction_Report_Austin() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the transactionSale report Url
		driver.get(Utility.getProperty("baseURL")+"5c41e5dd90d88f0001d47213/report/transactionSale");
	...
	public void getTheValue_Of_Tax_Report_Austin() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the taxReport report Url
		driver.get(Utility.getProperty("baseURL")+"5c41e5dd90d88f0001d47213/taxReport");
	...
	public void getTheValue_Of_Payroll_Report_Austin() throws Exception
	{
		...
		Thread.sleep(3000);
		//Enter the roleBasedPayroll report Url
		driver.get(Utility.getProperty("baseURL")+"5c41e5dd90d88f0001d47213/roleBasedPayroll");
	...
	public void diff_Austin() throws Exception
	{		
		File src = new File(Utility.getProperty("Excel_Sheet_Path"));
