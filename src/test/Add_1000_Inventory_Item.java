...
public class Add_1000_Inventory_Item {
	...
	ExtentTest test = rep.startTest("AddEditDelete Modifier Group");
		...
		public void Add_Inventory_Item() throws Exception
		{
			...
			for(int i = 96; i <= 200; i++)
			{
				...
				driver.findElement(By.xpath("//a[@id='inventoryItem']")).click();
				
				Thread.sleep(2000);
				driver.findElement(By.name("name")).sendKeys("Inv_Item_"+i);
				...
				else
				{
					driver.findElement(By.xpath("//div[@id='category_chosen']/a")).click();
					//Enter the Required Category
					driver.findElement(By.xpath("//div[@id='category_chosen']/div/div/input")).sendKeys("Beverages");
					//Press the Enter Key
					driver.findElement(By.xpath("//div[@id='category_chosen']/div/div/input")).sendKeys(Keys.ENTER);
				}
				...
				else
				{
					...
					driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div/div/div[2]/div/div[2]/form/div[2]/div/div/div/div[2]/ng-form/div/div/div[1]/div[1]/div/div/a")).click();
					//Enter the required vendor
					driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div/div/div[2]/div/div[2]/form/div[2]/div/div/div/div[2]/ng-form/div/div/div[1]/div[1]/div/div/div/div/input")).sendKeys("Mano");
					//Press the Enter button
					driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div/div/div[2]/div/div[2]/form/div[2]/div/div/div/div[2]/ng-form/div/div/div[1]/div[1]/div/div/div/div/input")).sendKeys(Keys.ENTER);
				}
				...
				driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div/div/div[2]/div/div[2]/form/div[2]/div/div/div/div[2]/ng-form/div/div/div[1]/div[4]/div/div/div/div/input")).sendKeys("Kilo");
				//Press the Enter button
				...
				driver.findElement(By.name("purchaseUnitMultiplier")).sendKeys("10000");
				
				//Clear the Quantity option
				driver.findElement(By.name("receivingQuantity")).clear();
				//Enter the required Quantity
				driver.findElement(By.name("receivingQuantity")).sendKeys("10000");
				...
				driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div/div/div[2]/div/div[2]/form/div[3]/div/div/div/div[1]/div/div/ng-form/div/div/div[3]/div/div/div/input")).sendKeys("Kilo");
				//Press the Enter button
